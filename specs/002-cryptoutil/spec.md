...
| **identity-authz** | Identity | Authorization Server (authz) | 8100-8109 | 127.0.0.1:9090 | OAuth 2.1 authorization server, OIDC Discovery |
| **identity-idp** | Identity | Identity Provider (IdP) | 8100-8109 | 127.0.0.1:9090 | OIDC 1.0 authentication, login/consent UI, MFA enrollment |
| **identity-rs** | Identity | Resource Server (RS) | 8110-8119 | 127.0.0.1:9090 | Protected API with token validation (reference implementation) |
| **identity-rp** | Identity | Relying Party (RP) | 8120-8129 | 127.0.0.1:9090 | Backend-for-Frontend pattern (reference implementation) |
| **identity-spa** | Identity | Single Page Application (SPA) | 8130-8139 | 127.0.0.1:9090 | Static hosting for SPA clients (reference implementation) |
