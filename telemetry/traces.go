...
func DoTraceExample(ctx context.Context, slogger *slog.Logger, tracesProvider *trace.TracerProvider) {
	exampleTrace := tracesProvider.Tracer("example-trace")
	slogger.Info("exampleTrace", "trace", exampleTrace)
	...
	slogger.Info("exampleParentSpan", "ctx", exampleParentSpanContext, "span", exampleParentSpan)
	...
	slogger.Info("exampleChildSpan1", "ctx", exampleChildSpanContext1, "span", exampleChildSpan1)
	...
	slogger.Info("exampleChildSpan2", "ctx", exampleChildSpanContext2, "span", exampleChildSpan2)
