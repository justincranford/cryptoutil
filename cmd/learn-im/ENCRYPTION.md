# learn-im Encryption Architecture

Technical details of cryptographic operations in learn-im service.

## Overview

learn-im uses **hybrid encryption** combining RSA-OAEP (asymmetric) for
...
- learn-im: Server-side keys, no forward secrecy
...
- learn-im: Server-side keys (demo only)
...
- learn-im: At-rest encryption (database records encrypted)
- Combined: TLS + learn-im = defense in depth
