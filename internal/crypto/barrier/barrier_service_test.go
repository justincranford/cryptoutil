...
func Test_HappyPath_EncryptDecryptContent_Restart_DecryptAgain(t *testing.T) {
	...
	unsealJwks := cryptoutilJose.GenerateAes256KeysForTest(t, 2, &cryptoutilJose.AlgA256GCMKW, &cryptoutilJose.EncA256GCM)
	...
	_, invalidJwk, _, err := cryptoutilJose.GenerateAesJWK(&cryptoutilJose.AlgA256GCMKW, &cryptoutilJose.EncA256GCM)
	require.NoError(t, err)
