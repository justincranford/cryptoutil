...
import (
	...
	cryptoutilCipherServerUtil "cryptoutil/internal/cipher/server/util"
)

const (
	// ContextKeyUserID is the context key for storing user ID from JWT.
	ContextKeyUserID = cryptoutilCipherServerUtil.ContextKeyUserID
)

// Claims represents JWT claims for cipher-im authentication.
type Claims = cryptoutilCipherServerUtil.Claims
