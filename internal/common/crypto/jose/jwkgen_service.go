...
func NewJWKGenService(ctx context.Context, telemetryService *cryptoutilTelemetry.TelemetryService) (*JWKGenService, error) {
	...
	rsa4096KeyGenPool, err1 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService RSA 4096", cryptoutilMagic.JWKGenPoolRSA4096NumWorkers, cryptoutilMagic.JWKGenPoolRSA4096PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateRSAKeyPairFunction(cryptoutilMagic.RSAKeySize4096), verbose))
	rsa3072KeyGenPool, err2 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService RSA 3072", cryptoutilMagic.JWKGenPoolRSA3072NumWorkers, cryptoutilMagic.JWKGenPoolRSA3072PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateRSAKeyPairFunction(cryptoutilMagic.RSAKeySize3072), verbose))
	rsa2048KeyGenPool, err3 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService RSA 2048", cryptoutilMagic.JWKGenPoolRSA2048NumWorkers, cryptoutilMagic.JWKGenPoolRSA2048PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateRSAKeyPairFunction(cryptoutilMagic.RSAKeySize2048), verbose))
	...
	ecdsaP256KeyGenPool, err6 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService ECDSA-P256", cryptoutilMagic.JWKGenPoolECDSAP256NumWorkers, cryptoutilMagic.JWKGenPoolECDSAP256PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateECDSAKeyPairFunction(elliptic.P256()), verbose))
	ecdhP521KeyGenPool, err7 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService ECDH-P521", cryptoutilMagic.JWKGenPoolECDHP521NumWorkers, cryptoutilMagic.JWKGenPoolECDHP521PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateECDHKeyPairFunction(ecdh.P521()), verbose))
	ecdhP384KeyGenPool, err8 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService ECDH-P384", cryptoutilMagic.JWKGenPoolECDHP384NumWorkers, cryptoutilMagic.JWKGenPoolECDHP384PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateECDHKeyPairFunction(ecdh.P384()), verbose))
	...
	ed25519KeyGenPool, err10 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService Ed25519", cryptoutilMagic.JWKGenPoolED25519NumWorkers, cryptoutilMagic.JWKGenPoolED25519PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateEDDSAKeyPairFunction("Ed25519"), verbose))
	aes256KeyGenPool, err11 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService AES-256-GCM", cryptoutilMagic.JWKGenPoolAES256NumWorkers, cryptoutilMagic.JWKGenPoolAES256PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateAESKeyFunction(cryptoutilMagic.AESKeySize256), verbose))
	aes192KeyGenPool, err12 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService AES-192-GCM", cryptoutilMagic.JWKGenPoolAES192NumWorkers, cryptoutilMagic.JWKGenPoolAES192PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateAESKeyFunction(cryptoutilMagic.AESKeySize192), verbose))
	...
	aes256HS512KeyGenPool, err14 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService AES-256-CBC HS-512", cryptoutilMagic.JWKGenPoolAES256NumWorkers, cryptoutilMagic.JWKGenPoolAES256PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateAESHSKeyFunction(cryptoutilMagic.HMACKeySize512), verbose))
	aes192HS384KeyGenPool, err15 := cryptoutilPool.NewValueGenPool(cryptoutilPool.NewValueGenPoolConfig(ctx, telemetryService, "JWKGenService AES-192-CBC HS-384", cryptoutilMagic.JWKGenPoolAES192NumWorkers, cryptoutilMagic.JWKGenPoolAES192PoolSize, cryptoutilMagic.MaxLifetimeValues, cryptoutilMagic.MaxLifetimeDuration, cryptoutilKeyGen.GenerateAESHSKeyFunction(cryptoutilMagic.HMACKeySize384), verbose))
