...
func TestCertificateChain(t *testing.T) {
	...
	t.Run("Root CA 1", func(t *testing.T) {
		...
		verify1RootsPool.AddCert(rootCert1.Cert) // subsequent verify cert chain calls need the root CA
	})
	...
	t.Run("Intermediate CA 1", func(t *testing.T) {
		...
		verify1IntermediatesPool.AddCert(intermediateCert1.Cert) // subsequent verify cert chain calls need the intermediate CA
	})
	...
	t.Run("Issuing CA 1", func(t *testing.T) {
		...
		verify1IntermediatesPool.AddCert(issuingCert1.Cert) // subsequent verify cert chain calls need the issuing CA
	})
