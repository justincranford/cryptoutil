...
const (
	...
	// JoseJAE2EPublicCACertPath is the path to the public HTTPS server CA cert generated by pki-init.
	// Path is relative to the e2e test directory (internal/apps/jose-ja/e2e/).
	JoseJAE2EPublicCACertPath = "../../../../deployments/jose-ja/certs/jose-ja/public-https-server-issuing-ca/truststore/public-https-server-issuing-ca.crt"
)
