...
const (
	...
	// IME2EPublicCACertPath is the path to the public HTTPS server CA cert generated by pki-init.
	// Path is relative to the e2e test directory (internal/apps/sm-im/e2e/).
	IME2EPublicCACertPath = "../../../../deployments/sm-im/certs/sm-im/public-https-server-issuing-ca/truststore/public-https-server-issuing-ca.crt"
)
