...
const (
	...
	// KMSE2EPublicCACertPath is the path to the public HTTPS server CA cert generated by pki-init.
	// Path is relative to the e2e test directory (internal/apps/sm-kms/e2e/).
	// pki-init mounts output to deployments/sm-kms/certs/ on the host.
	KMSE2EPublicCACertPath = "../../../../deployments/sm-kms/certs/sm-kms/public-https-server-issuing-ca/truststore/public-https-server-issuing-ca.crt"
