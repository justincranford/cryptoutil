...
const (
	...
	// KMSE2ESQLite2Container is the SQLite instance 2 service name in compose.
	KMSE2ESQLite2Container = "sm-kms-app-sqlite-2"

	// KMSE2EPostgreSQL1Container is the PostgreSQL instance 1 service name in compose.
	KMSE2EPostgreSQL1Container = "sm-kms-app-postgresql-1"

	// KMSE2EPostgreSQL2Container is the PostgreSQL instance 2 service name in compose.
	KMSE2EPostgreSQL2Container = "sm-kms-app-postgresql-2"
	...
	// KMSE2ESQLite2PublicPort is the SQLite instance 2 public HTTPS port (SERVICE level: 8001).
	KMSE2ESQLite2PublicPort = 8001

	// KMSE2EPostgreSQL1PublicPort is the PostgreSQL instance 1 public HTTPS port (SERVICE level: 8002).
	KMSE2EPostgreSQL1PublicPort = 8002

	// KMSE2EPostgreSQL2PublicPort is the PostgreSQL instance 2 public HTTPS port (SERVICE level: 8003).
	KMSE2EPostgreSQL2PublicPort = 8003
