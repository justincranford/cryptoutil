...
var (
	...
	EncInvalid      = joseJwa.NewContentEncryptionAlgorithm(cryptoutilSharedMagic.DevSetupTestInvalidName) // ContentEncryptionAlgorithm
	...
	AlgEncInvalid   = joseJwa.NewKeyEncryptionAlgorithm(cryptoutilSharedMagic.DevSetupTestInvalidName) // KeyEncryptionAlgorithm
	...
	AlgSigInvalid = joseJwa.NewSignatureAlgorithm(cryptoutilSharedMagic.DevSetupTestInvalidName) // SignatureAlgorithm
