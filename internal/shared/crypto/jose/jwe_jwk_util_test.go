...
func TestValidateOrGenerateJWEAESJWK_NilKey(t *testing.T) {
	...
	// Test nil key bytes.
	var secretKey cryptoutilKeyGen.SecretKey
...
func TestCreateJWEJWKFromKey_RSA_AllAlgorithms(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			kid := googleUuid.New()
			keyPair, err := cryptoutilKeyGen.GenerateRSAKeyPair(tt.keySize)
			require.NoError(t, err)
...
func TestCreateJWEJWKFromKey_ECDH_AllCurves(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			kid := googleUuid.New()
			keyPair, err := cryptoutilKeyGen.GenerateECDHKeyPair(tt.curve)
			require.NoError(t, err)
...
func TestCreateJWEJWKFromKey_AES_AllSizes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			kid := googleUuid.New()
			secretKey, err := cryptoutilKeyGen.GenerateAESKey(tt.keySize)
			require.NoError(t, err)
