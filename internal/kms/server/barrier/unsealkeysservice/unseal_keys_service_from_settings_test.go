...
func createTestContext(t *testing.T) (context.Context, *cryptoutilTelemetry.TelemetryService) {
	t.Helper()

	ctx := context.Background()
	settings := cryptoutilConfig.RequireNewForTest("unsealkeysservice-test")

	return ctx, cryptoutilTelemetry.RequireNewForTest(ctx, settings)
}
...
func TestNewUnsealKeysServiceFromSettings_DevMode(t *testing.T) {
	...
	settings := cryptoutilConfig.RequireNewForTest("test-dev-mode")
...
func TestNewUnsealKeysServiceFromSettings_SysInfoMode(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-sysinfo-mode")
	settings.DevMode = false
	settings.UnsealMode = "sysinfo"
...
func TestNewUnsealKeysServiceFromSettings_InvalidMofNFormat(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-invalid-mofn")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidMValue(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-invalid-m")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidNValue(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-invalid-n")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidMNValues(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ctx, telemetryService := createTestContext(t)
			settings := cryptoutilConfig.RequireNewForTest("test-invalid-mn-" + tc.name)
			settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidSimpleMode(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-invalid-simple")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_ZeroSimpleMode(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-zero-simple")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_MissingFiles(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-missing-files")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_FileMismatch(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-file-mismatch")
	settings.DevMode = false
...
func TestUnsealKeysServiceFromSettings_EncryptDecrypt(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilConfig.RequireNewForTest("test-encrypt-decrypt")
	settings.DevMode = true
