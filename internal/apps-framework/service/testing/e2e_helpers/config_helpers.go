...
// Extracted from sm-kms implementation to support 9-service migration.
package e2e_helpers
...
// NewTestServerSettings creates ServiceFrameworkServerSettings with test-friendly defaults.
// Reusable for all services requiring ServiceFrameworkServerSettings in tests.
//
...
func NewTestServerSettings() *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings {
	return &cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings{
...
// NewTestServerSettingsWithService creates ServiceFrameworkServerSettings with custom service name.
// Useful when multiple service instances need distinct telemetry names.
func NewTestServerSettingsWithService(serviceName string) *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings {
