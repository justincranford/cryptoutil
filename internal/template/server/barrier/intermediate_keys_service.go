...
func NewIntermediateKeysService(telemetryService *cryptoutilTelemetry.TelemetryService, jwkGenService *cryptoutilJose.JWKGenService, repository BarrierRepository, rootKeysService *cryptoutilRootKeysService.RootKeysService) (*IntermediateKeysService, error) {
...
func initializeFirstIntermediateJWK(jwkGenService *cryptoutilJose.JWKGenService, repository BarrierRepository, rootKeysService *cryptoutilRootKeysService.RootKeysService) error {
