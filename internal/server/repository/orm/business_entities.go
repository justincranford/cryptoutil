...
type ElasticKey struct {
	...
	ElasticKeyProvider          ElasticKeyProvider  `gorm:"size:8;not null;check:elastic_key_provider IN ('Internal')"`
	ElasticKeyAlgorithm         ElasticKeyAlgorithm `gorm:"size:26;not null"`
