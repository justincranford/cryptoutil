...
type ElasticKey struct {
	...
	ElasticKeyProvider          constant.ElasticKeyProvider  `gorm:"size:8;not null;check:elastic_key_provider IN ('Internal')"`
	ElasticKeyAlgorithm         constant.ElasticKeyAlgorithm `gorm:"size:26;not null"`
