...
var (
	asymmetricKeyPoolAlgorithm = map[KeyPoolAlgorithm]bool{
...
var symmetricKeyPoolAlgorithm = map[KeyPoolAlgorithm]bool{
...
func IsAsymmetric(alg *KeyPoolAlgorithm) bool {
	return asymmetricKeyPoolAlgorithm[*alg]
}

func IsSymmetric(alg *KeyPoolAlgorithm) bool {
	return symmetricKeyPoolAlgorithm[*alg]
}
