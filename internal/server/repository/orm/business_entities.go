...
type ElasticKey struct {
	...
	ElasticKeyProvider          businessmodel.ElasticKeyProvider  `gorm:"size:8;not null;check:elastic_key_provider IN ('Internal')"`
	ElasticKeyAlgorithm         businessmodel.ElasticKeyAlgorithm `gorm:"size:26;not null"`
