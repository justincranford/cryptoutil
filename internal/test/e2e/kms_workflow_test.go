...
func (suite *KMSWorkflowSuite) TestEncryptDecryptWorkflow() {
	...
	genResp, err := suite.fixture.sqliteClient.PostElastickeyElasticKeyIDGenerateWithTextBody(ctx, *elasticKeyID, nil, "")
	suite.Require().NoError(err)
...
func (suite *KMSWorkflowSuite) TestKeyRotationWorkflow() {
	...
	genResp1, err := suite.fixture.sqliteClient.PostElastickeyElasticKeyIDGenerateWithTextBody(ctx, *elasticKeyID, nil, "")
	suite.Require().NoError(err)
	...
	genResp2, err := suite.fixture.sqliteClient.PostElastickeyElasticKeyIDGenerateWithTextBody(ctx, *elasticKeyID, nil, "")
	suite.Require().NoError(err)
