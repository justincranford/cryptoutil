...
var knownProducts = []string{cryptoutilSharedMagic.IdentityProductName, cryptoutilSharedMagic.PKIProductName, cryptoutilSharedMagic.SkeletonProductName, cryptoutilSharedMagic.SMProductName}
