...
func (r *ItemRepository) Create(ctx context.Context, item *cryptoutilAppsSkeletonTemplateServerModel.TemplateItem) error {
...
func (r *ItemRepository) GetByID(ctx context.Context, tenantID, itemID googleUuid.UUID) (*cryptoutilAppsSkeletonTemplateServerModel.TemplateItem, error) {
	var item cryptoutilAppsSkeletonTemplateServerModel.TemplateItem
...
func (r *ItemRepository) List(ctx context.Context, tenantID googleUuid.UUID, page, size int) ([]cryptoutilAppsSkeletonTemplateServerModel.TemplateItem, int64, error) {
	var items []cryptoutilAppsSkeletonTemplateServerModel.TemplateItem

	var total int64

	query := r.db.WithContext(ctx).Model(&cryptoutilAppsSkeletonTemplateServerModel.TemplateItem{}).Where("tenant_id = ?", tenantID.String())
...
func (r *ItemRepository) Update(ctx context.Context, item *cryptoutilAppsSkeletonTemplateServerModel.TemplateItem) error {
...
func (r *ItemRepository) Delete(ctx context.Context, tenantID, itemID googleUuid.UUID) error {
	result := r.db.WithContext(ctx).Where("tenant_id = ? AND id = ?", tenantID.String(), itemID.String()).Delete(&cryptoutilAppsSkeletonTemplateServerModel.TemplateItem{})
	if result.Error != nil {
