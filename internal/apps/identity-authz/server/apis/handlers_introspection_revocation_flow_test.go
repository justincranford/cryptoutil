...
import (
	...
	cryptoutilIdentityAuthz "cryptoutil/internal/apps/identity-authz/server/apis"
...
func TestIntrospectionRevocationFlow(t *testing.T) {
	...
	t.Log("âœ… Step 1 PASSED: Token is active")
	...
	t.Log("âœ… Step 2 PASSED: Token revoked successfully")
	...
	t.Log("âœ… Step 3 PASSED: Token is inactive after revocation")
	t.Log("âœ… FULL FLOW PASSED: Introspection correctly validates revocation status")
}
