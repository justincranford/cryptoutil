...
// This validates login â†’ consent flow and userinfo endpoint functionality.
//
// Validates requirement R02-07: OIDC integration tests.
// Note: Full E2E OIDC flow (authorize â†’ token) requires authz service and is tested in
