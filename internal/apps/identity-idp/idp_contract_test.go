...
import (
	...
	cryptoutilIdentityIdp "cryptoutil/internal/apps/identity-idp/server/apis"
	cryptoutilIdentityConfig "cryptoutil/internal/apps/identity/config"
	cryptoutilIdentityIssuer "cryptoutil/internal/apps/identity/issuer"
	cryptoutilIdentityRepository "cryptoutil/internal/apps/identity/repository"
)

// TestIdPContractHealth verifies the /health endpoint complies with the OpenAPI spec.
func TestIdPContractHealth(t *testing.T) {
	t.Parallel()

	// Load OpenAPI spec for validation.
	spec, err := cryptoutilApiIdentityIdp.GetSwagger()
