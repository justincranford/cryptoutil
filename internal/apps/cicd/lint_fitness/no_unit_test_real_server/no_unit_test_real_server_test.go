...
var listenViolationPrefix = "package handler_test\n\nfunc TestFoo(t *testing.T) {\n\tapp := fiber.New()\n\tgo app."
var listenViolationSuffix = `Listen(":8080")` + "\n}\n"
var listenViolationContent = listenViolationPrefix + listenViolationSuffix
