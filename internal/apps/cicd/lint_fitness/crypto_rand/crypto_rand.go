...
func FindMathRandViolationsInDir(rootDir string) ([]lintGoCommon.CryptoViolation, error) {
	...
	err := filepath.WalkDir(rootDir, func(path string, d os.DirEntry, err error) error {
		...
		// Use filepath.ToSlash for cross-platform path matching (Windows uses backslash separators).
		...
		if strings.Contains(normalizedPath, "/testing/") ||
			...
			strings.Contains(normalizedPath, "cmd/demo/") ||
			strings.Contains(normalizedPath, "cmd/identity-demo/") ||
