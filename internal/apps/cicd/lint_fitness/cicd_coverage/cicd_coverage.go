...
logger.Log("Checking cicd command coverage in pre-commit config and CI workflow...")
...
logger.Log(fmt.Sprintf("cicd-coverage: all %d linters and %d formatters are covered in all 2 required files",
