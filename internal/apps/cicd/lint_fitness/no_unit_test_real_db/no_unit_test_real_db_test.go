...
var postgresViolationPrefix = "package repo_test\n\nfunc TestFoo(t *testing.T) {\n\tcontainer, err := postgres"
var postgresViolationSuffix = "Module.Run(ctx, \"postgres:16-alpine\")\n\t_ = container\n\t_ = err\n}\n"
var postgresViolationContent = postgresViolationPrefix + postgresViolationSuffix

var postgresRunContainerViolationContent = "package repo_test\n\nfunc TestFoo(t *testing.T) {\n\tcontainer, err := postgres.RunContainer(ctx)\n\t_ = container\n\t_ = err\n}\n"

var newPostgresHelperViolationPrefix = "package repo_test\n\nfunc TestFoo(t *testing.T) {\n\tdb := cryptoutilTestingTestdb"
var newPostgresHelperViolationSuffix = ".NewPostgresTestContainer(ctx, t)\n\t_ = db\n}\n"
var newPostgresHelperViolationContent = newPostgresHelperViolationPrefix + newPostgresHelperViolationSuffix
