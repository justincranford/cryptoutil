...
// fixTHelper adds t.Helper() to test helper functions that are missing it.
// Returns the number of files processed, modified, and issues fixed.
func fixTHelper(logger *cryptoutilCmdCicdCommon.Logger, rootDir string) (int, int, int, error) {
