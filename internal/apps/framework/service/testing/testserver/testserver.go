...
//	    os.Exit(m.Run())
//	}
func StartAndWait(ctx context.Context, t testing.TB, srv cryptoutilAppsFrameworkServiceServer.ServiceServer) cryptoutilAppsFrameworkServiceServer.ServiceServer {
	t.Helper()
