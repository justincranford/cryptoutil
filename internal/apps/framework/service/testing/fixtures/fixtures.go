...
func CreateTestTenant(t testing.TB, db *gorm.DB) *cryptoutilAppsFrameworkServiceServerRepository.Tenant {
	t.Helper()
...
func CreateTestRealm(t testing.TB, db *gorm.DB, tenantID googleUuid.UUID) *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm {
	t.Helper()
...
func CreateTestUser(t testing.TB, db *gorm.DB, tenantID googleUuid.UUID) *cryptoutilAppsFrameworkServiceServerRepository.User {
	t.Helper()
