...
// NewTestConfig creates a ServiceFrameworkServerSettings instance for testing without calling Parse().
...
//
// Returns directly populated ServiceFrameworkServerSettings matching NewForJOSEServer/NewForCAServer behavior.
func NewTestConfig(bindAddr string, bindPort uint16, devMode bool) *ServiceFrameworkServerSettings {
