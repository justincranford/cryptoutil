...
func TestAnalyzeSettings_RealSettings(t *testing.T) {
	result := analyzeSettings(allServiceFrameworkServerRegisteredSettings)
	...
	require.Equal(t, len(allServiceFrameworkServerRegisteredSettings), totalMappedByName, "All settings should be accounted for by name")
