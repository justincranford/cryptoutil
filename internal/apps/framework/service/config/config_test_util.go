...
// RequireNewForTest creates a new ServiceFrameworkServerSettings with test defaults.
func RequireNewForTest(applicationName string) *ServiceFrameworkServerSettings {
...
// NewFromFile loads *ServiceFrameworkServerSettings from a YAML configuration file.
...
func NewFromFile(filePath string) (*ServiceFrameworkServerSettings, error) {
