...
func TestHandleRegisterUser_ServiceError(t *testing.T) {
	...
	closedDB, initErr := cryptoutilAppsFrameworkServiceServerRepository.InitSQLite(
		ctx,
	...
	tenantRepo := cryptoutilAppsFrameworkServiceServerRepository.NewTenantRepository(closedDB)
	userRepo := cryptoutilAppsFrameworkServiceServerRepository.NewUserRepository(closedDB)
	joinRepo := cryptoutilAppsFrameworkServiceServerRepository.NewTenantJoinRequestRepository(closedDB)
