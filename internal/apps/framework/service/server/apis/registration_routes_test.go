...
func (m *mockSessionValidator) ValidateBrowserSession(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.BrowserSession, error) {
	// Return nil to indicate no session found (simulates unauthenticated request)
	return nil, nil
}

func (m *mockSessionValidator) ValidateServiceSession(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.ServiceSession, error) {
	// Return nil to indicate no session found (simulates unauthenticated request)
	return nil, nil
}
