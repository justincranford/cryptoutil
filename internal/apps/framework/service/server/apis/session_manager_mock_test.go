...
type mockSessionManager struct {
	...
	validateBrowserFunc func(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.BrowserSession, error)
	validateServiceFunc func(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.ServiceSession, error)
}
...
func (m *mockSessionManager) ValidateBrowserSession(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.BrowserSession, error) {
...
func (m *mockSessionManager) ValidateServiceSession(ctx context.Context, token string) (*cryptoutilAppsFrameworkServiceServerRepository.ServiceSession, error) {
...
func newMockSessionManagerError(err error) *mockSessionManager {
	return &mockSessionManager{
		...
		validateBrowserFunc: func(context.Context, string) (*cryptoutilAppsFrameworkServiceServerRepository.BrowserSession, error) {
			return nil, err
		},
		validateServiceFunc: func(context.Context, string) (*cryptoutilAppsFrameworkServiceServerRepository.ServiceSession, error) {
			return nil, err
		},
	}
}
