...
type mockRealmRepoWithErrors struct {
	...
	listByTenantRealms []*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm
	realm              *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm
}

func (m *mockRealmRepoWithErrors) Create(ctx context.Context, realm *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm) error {
	return m.createErr
}

func (m *mockRealmRepoWithErrors) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	return nil, nil
}

func (m *mockRealmRepoWithErrors) GetByRealmID(ctx context.Context, tenantID, realmID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
...
func (m *mockRealmRepoWithErrors) GetByName(ctx context.Context, tenantID googleUuid.UUID, name string) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	return nil, nil
}

func (m *mockRealmRepoWithErrors) ListByTenant(_ context.Context, _ googleUuid.UUID, _ bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
...
func (m *mockRealmRepoWithErrors) Update(ctx context.Context, realm *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm) error {
	return m.updateErr
}
...
func TestGetFirstActiveRealm_EmptyList(t *testing.T) {
	...
	tenantID := googleUuid.New()
	mockRepo := &mockRealmRepoWithErrors{listByTenantRealms: []*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{}}
	svc := NewRealmService(mockRepo)
...
func TestGetFirstActiveRealm_Success(t *testing.T) {
	...
	tenantID := googleUuid.New()
	activeRealm := &cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{
		ID:       googleUuid.New(),
		TenantID: tenantID,
		RealmID:  googleUuid.New(),
		Active:   true,
	...
	mockRepo := &mockRealmRepoWithErrors{
		listByTenantRealms: []*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{activeRealm},
	}
	svc := NewRealmService(mockRepo)
...
func TestUpdateRealm_JsonMarshalError(t *testing.T) {
	...
	tenantID := googleUuid.New()
	realmID := googleUuid.New()
	existingRealm := &cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{
		ID:       googleUuid.New(),
		TenantID: tenantID,
		RealmID:  realmID,
		Active:   true,
