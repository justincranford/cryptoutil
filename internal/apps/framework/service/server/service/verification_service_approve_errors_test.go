...
type mockRoleRepoForApprove struct {
	getByIDErr error
	role       *cryptoutilAppsFrameworkServiceServerRepository.Role
}

func (m *mockRoleRepoForApprove) Create(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	return nil
}

func (m *mockRoleRepoForApprove) GetByID(_ context.Context, _ googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	if m.getByIDErr != nil {
...
func (m *mockRoleRepoForApprove) GetByName(_ context.Context, _ googleUuid.UUID, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockRoleRepoForApprove) ListByTenant(_ context.Context, _ googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}
...
func (m *mockUserRepoForApprove) Create(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.User) error {
	return m.createErr
}

func (m *mockUserRepoForApprove) GetByID(_ context.Context, _ googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.User, error) {
	return nil, nil
}

func (m *mockUserRepoForApprove) GetByUsername(_ context.Context, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.User, error) {
	return nil, nil
}

func (m *mockUserRepoForApprove) GetByEmail(_ context.Context, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.User, error) {
	return nil, nil
}

func (m *mockUserRepoForApprove) ListByTenant(_ context.Context, _ googleUuid.UUID, _ bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.User, error) {
	return nil, nil
}

func (m *mockUserRepoForApprove) Update(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.User) error {
	return nil
}
...
func (m *mockUserRoleRepoForApprove) Assign(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.UserRole) error {
	return m.assignErr
}
...
func (m *mockUserRoleRepoForApprove) ListRolesByUser(_ context.Context, _ googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockUserRoleRepoForApprove) ListUsersByRole(_ context.Context, _ googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.User, error) {
	return nil, nil
}
...
func (m *mockClientRepoForApprove) Create(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return m.createErr
}

func (m *mockClientRepoForApprove) GetByID(_ context.Context, _ googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForApprove) GetByClientID(_ context.Context, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForApprove) ListByTenant(_ context.Context, _ googleUuid.UUID, _ bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForApprove) Update(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return nil
}
...
func (m *mockClientRoleRepoForApprove) Assign(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.ClientRole) error {
	return m.assignErr
}
...
func (m *mockClientRoleRepoForApprove) ListRolesByClient(_ context.Context, _ googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockClientRoleRepoForApprove) ListClientsByRole(_ context.Context, _ googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

// --- Helper to create a valid unverified user with matching tenant ---

func newApproveTestUnverifiedUser(tenantID googleUuid.UUID) *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser {
	return &cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser{
		ID:           googleUuid.New(),
		TenantID:     tenantID,
		Username:     "testuser",
...
func newApproveVerificationService(
	userRepo cryptoutilAppsFrameworkServiceServerRepository.UserRepository,
	clientRepo cryptoutilAppsFrameworkServiceServerRepository.ClientRepository,
	unverifiedUserRepo cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUserRepository,
	unverifiedClientRepo cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClientRepository,
	roleRepo cryptoutilAppsFrameworkServiceServerRepository.RoleRepository,
	userRoleRepo cryptoutilAppsFrameworkServiceServerRepository.UserRoleRepository,
	clientRoleRepo cryptoutilAppsFrameworkServiceServerRepository.ClientRoleRepository,
...
func TestApproveUser_UserCreateError(t *testing.T) {
	...
	svc := newApproveVerificationService(
		...
		&mockUnverifiedUserRepoWithErrors{user: unverifiedUser},
		&mockUnverifiedClientRepoWithErrors{},
		&mockRoleRepoForApprove{role: &cryptoutilAppsFrameworkServiceServerRepository.Role{ID: roleID, TenantID: tenantID}},
		&mockUserRoleRepoForApprove{},
		&mockClientRoleRepoForApprove{},
	)
...
func TestApproveClient_DeleteUnverifiedError(t *testing.T) {
	...
	unverifiedClient := &cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient{
		ID:               googleUuid.New(),
		TenantID:         tenantID,
		ClientID:         "testclient",
