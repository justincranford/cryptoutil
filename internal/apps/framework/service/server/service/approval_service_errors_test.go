...
func (m *mockUnverifiedClientRepoForApproval) Create(_ context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient) error {
	return nil
}

func (m *mockUnverifiedClientRepoForApproval) GetByID(_ context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	if m.getByIDErr != nil {
...
func (m *mockUnverifiedClientRepoForApproval) GetByClientID(_ context.Context, clientID string) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}

func (m *mockUnverifiedClientRepoForApproval) ListByTenant(_ context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}
...
func (m *mockRoleRepoForApproval) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	if m.getByIDErr != nil {
		return nil, m.getByIDErr
	}
...
func (m *mockRoleRepoForApproval) GetByName(ctx context.Context, tenantID googleUuid.UUID, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockRoleRepoForApproval) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockRoleRepoForApproval) Create(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	return nil
}

func (m *mockRoleRepoForApproval) Update(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	return nil
}
...
func (m *mockClientRepo) Create(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return m.createErr
}

func (m *mockClientRepo) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepo) GetByClientID(ctx context.Context, clientID string) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepo) ListByTenant(ctx context.Context, tenantID googleUuid.UUID, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepo) Update(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return nil
}
...
func (m *mockClientRoleRepo) Assign(ctx context.Context, clientRole *cryptoutilAppsFrameworkServiceServerRepository.ClientRole) error {
	return m.assignErr
}
...
func (m *mockClientRoleRepo) ListRolesByClient(ctx context.Context, clientID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockClientRoleRepo) ListClientsByRole(ctx context.Context, roleID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}
