...
type mockTenantRepository struct {
	createFn               func(ctx context.Context, tenant *cryptoutilAppsFrameworkServiceServerRepository.Tenant) error
	getByIDFn              func(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error)
	getByNameFn            func(ctx context.Context, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error)
	listFn                 func(ctx context.Context, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error)
	updateFn               func(ctx context.Context, tenant *cryptoutilAppsFrameworkServiceServerRepository.Tenant) error
...
func (m *mockTenantRepository) Create(ctx context.Context, tenant *cryptoutilAppsFrameworkServiceServerRepository.Tenant) error {
	if m.createFn != nil {
...
func (m *mockTenantRepository) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	if m.getByIDFn != nil {
...
func (m *mockTenantRepository) GetByName(ctx context.Context, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
...
func (m *mockTenantRepository) List(ctx context.Context, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	if m.listFn != nil {
...
func (m *mockTenantRepository) Update(ctx context.Context, tenant *cryptoutilAppsFrameworkServiceServerRepository.Tenant) error {
	if m.updateFn != nil {
...
type mockRoleRepository struct {
	createFn       func(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error
	getByNameFn    func(ctx context.Context, tenantID googleUuid.UUID, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error)
	getByIDFn      func(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error)
	listByTenantFn func(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error)
	deleteFn       func(ctx context.Context, id googleUuid.UUID) error
}

func (m *mockRoleRepository) Create(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	if m.createFn != nil {
...
func (m *mockRoleRepository) GetByName(ctx context.Context, tenantID googleUuid.UUID, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	if m.getByNameFn != nil {
...
func (m *mockRoleRepository) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	if m.getByIDFn != nil {
		return m.getByIDFn(ctx, id)
	}
...
func (m *mockRoleRepository) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMocks: func(tenantRepo *mockTenantRepository, roleRepo *mockRoleRepository) {
				...
				roleRepo.createFn = func(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
					return nil
				}
			},
			wantErr: false,
	...
	tests := []struct {
		...
		},
		{
			...
			setupMocks: func(tenantRepo *mockTenantRepository) {
				...
				tenantRepo.getByIDFn = func(_ context.Context, _ googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMocks: func(tenantRepo *mockTenantRepository) {
				...
				tenantRepo.updateFn = func(_ context.Context, _ *cryptoutilAppsFrameworkServiceServerRepository.Tenant) error {
					return nil
				}
			},
			wantErr: false,
