...
func (m *mockTenantServiceForRegisterClient) CreateTenant(ctx context.Context, name, description string) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
...
func (m *mockTenantServiceForRegisterClient) GetTenant(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	return nil, nil
}

func (m *mockTenantServiceForRegisterClient) GetTenantByName(ctx context.Context, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	return nil, nil
}

func (m *mockTenantServiceForRegisterClient) ListTenants(ctx context.Context, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	return nil, nil
}

func (m *mockTenantServiceForRegisterClient) UpdateTenant(ctx context.Context, id googleUuid.UUID, name, description *string, active *bool) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	return nil, nil
}
...
func (m *mockClientRepoForRegisterClient) Create(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return m.createErr
}

func (m *mockClientRepoForRegisterClient) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForRegisterClient) GetByClientID(ctx context.Context, clientID string) (*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForRegisterClient) ListByTenant(ctx context.Context, tenantID googleUuid.UUID, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}

func (m *mockClientRepoForRegisterClient) Update(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.Client) error {
	return nil
}
...
func (m *mockRoleRepoForRegisterClient) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockRoleRepoForRegisterClient) GetByName(ctx context.Context, tenantID googleUuid.UUID, name string) (*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
...
func (m *mockRoleRepoForRegisterClient) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockRoleRepoForRegisterClient) Create(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	return nil
}

func (m *mockRoleRepoForRegisterClient) Update(ctx context.Context, role *cryptoutilAppsFrameworkServiceServerRepository.Role) error {
	return nil
}
...
func (m *mockClientRoleRepoForRegisterClient) Assign(ctx context.Context, clientRole *cryptoutilAppsFrameworkServiceServerRepository.ClientRole) error {
	return m.assignErr
}
...
func (m *mockClientRoleRepoForRegisterClient) ListRolesByClient(ctx context.Context, clientID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Role, error) {
	return nil, nil
}

func (m *mockClientRoleRepoForRegisterClient) ListClientsByRole(ctx context.Context, roleID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.Client, error) {
	return nil, nil
}
...
func (m *mockUnverifiedClientRepoForRegisterClient) Create(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient) error {
	return m.createErr
}

func (m *mockUnverifiedClientRepoForRegisterClient) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}

func (m *mockUnverifiedClientRepoForRegisterClient) GetByClientID(ctx context.Context, clientID string) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}

func (m *mockUnverifiedClientRepoForRegisterClient) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}
