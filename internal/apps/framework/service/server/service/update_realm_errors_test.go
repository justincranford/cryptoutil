...
func (m *mockRealmRepoForUpdate) Create(ctx context.Context, realm *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm) error {
	return nil
}

func (m *mockRealmRepoForUpdate) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	return nil, nil
}

func (m *mockRealmRepoForUpdate) GetByRealmID(ctx context.Context, tenantID, realmID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	if m.getByIDErr != nil {
...
func (m *mockRealmRepoForUpdate) ListByTenant(ctx context.Context, tenantID googleUuid.UUID, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	return nil, nil
}

func (m *mockRealmRepoForUpdate) Update(ctx context.Context, realm *cryptoutilAppsFrameworkServiceServerRepository.TenantRealm) error {
	return m.updateErr
}
