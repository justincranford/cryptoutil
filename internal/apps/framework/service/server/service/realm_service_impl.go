...
type RealmService interface {
	...
	CreateRealm(ctx context.Context, tenantID googleUuid.UUID, realmType string, config RealmConfig) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error)

	// GetRealm retrieves a realm by ID.
	GetRealm(ctx context.Context, tenantID, realmID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error)

	// ListRealms lists all realms for a tenant.
	ListRealms(ctx context.Context, tenantID googleUuid.UUID, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error)
	...
	GetFirstActiveRealm(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error)

	// UpdateRealm updates realm configuration.
	UpdateRealm(ctx context.Context, tenantID, realmID googleUuid.UUID, config RealmConfig, active *bool) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error)
...
func NewRealmService(realmRepo cryptoutilAppsFrameworkServiceServerRepository.TenantRealmRepository) RealmService {
...
// CreateRealm creates a new realm for a tenant.
func (s *RealmServiceImpl) CreateRealm(ctx context.Context, tenantID googleUuid.UUID, realmType string, config RealmConfig) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	...
	realm := &cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{
		ID:       googleUuid.New(),
		TenantID: tenantID,
...
// GetRealm retrieves a realm by ID.
func (s *RealmServiceImpl) GetRealm(ctx context.Context, tenantID, realmID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
...
// ListRealms lists all realms for a tenant.
func (s *RealmServiceImpl) ListRealms(ctx context.Context, tenantID googleUuid.UUID, activeOnly bool) ([]*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
...
// Returns the realm if found, or (nil, ErrNoActiveRealm) if no active realms exist.
// Callers MUST check errors.Is(err, ErrNoActiveRealm) to distinguish from real errors.
func (s *RealmServiceImpl) GetFirstActiveRealm(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
...
// UpdateRealm updates realm configuration.
func (s *RealmServiceImpl) UpdateRealm(ctx context.Context, tenantID, realmID googleUuid.UUID, config RealmConfig, active *bool) (*cryptoutilAppsFrameworkServiceServerRepository.TenantRealm, error) {
	// Get existing realm.
	realm, err := s.realmRepo.GetByRealmID(ctx, tenantID, realmID)
	if err != nil {
		return nil, fmt.Errorf("failed to get realm: %w", err)
