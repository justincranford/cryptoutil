...
type mockUnverifiedUserRepoWithErrors struct {
	...
	user             *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser
}

func (m *mockUnverifiedUserRepoWithErrors) Create(ctx context.Context, user *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser) error {
	return nil
}

func (m *mockUnverifiedUserRepoWithErrors) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser, error) {
	if m.getByIDErr != nil {
...
func (m *mockUnverifiedUserRepoWithErrors) GetByUsername(ctx context.Context, username string) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser, error) {
	return nil, nil
}

func (m *mockUnverifiedUserRepoWithErrors) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser, error) {
...
type mockUnverifiedClientRepoWithErrors struct {
	...
	deleteErr        error
	deleteExpiredErr error
	client           *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient
}

func (m *mockUnverifiedClientRepoWithErrors) Create(ctx context.Context, client *cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient) error {
	return nil
}

func (m *mockUnverifiedClientRepoWithErrors) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	if m.getByIDErr != nil {
		return nil, m.getByIDErr
	}
...
func (m *mockUnverifiedClientRepoWithErrors) GetByClientID(ctx context.Context, clientID string) (*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, nil
}

func (m *mockUnverifiedClientRepoWithErrors) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient, error) {
	return nil, m.listByTenantErr
}
