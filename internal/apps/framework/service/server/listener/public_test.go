...
func TestNewPublicHTTPServer_NilContext(t *testing.T) {
	...
	server, err := cryptoutilAppsFrameworkServiceServerListener.NewPublicHTTPServer(nil, cryptoutilAppsFrameworkServiceServerTestutil.ServiceFrameworkServerSettings(), tlsCfg) //nolint:staticcheck // Testing nil context handling.
...
func TestNewPublicHTTPServer_NilSettings(t *testing.T) {
	...
	server, err := cryptoutilAppsFrameworkServiceServerListener.NewPublicHTTPServer(context.Background(), nil, tlsCfg)
...
func TestNewPublicHTTPServer_NilTLSCfg(t *testing.T) {
	...
	server, err := cryptoutilAppsFrameworkServiceServerListener.NewPublicHTTPServer(context.Background(), cryptoutilAppsFrameworkServiceServerTestutil.ServiceFrameworkServerSettings(), nil)
...
func TestPublicHTTPServer_Shutdown_Graceful(t *testing.T) {
	...
	cryptoutilAppsFrameworkServiceTestingHttpservertests.TestShutdownGraceful(t, createServer)
}
