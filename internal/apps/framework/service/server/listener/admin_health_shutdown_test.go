...
func startAdminServerWithClient(t *testing.T) (*cryptoutilAppsFrameworkServiceServerListener.AdminServer, *http.Client, int, context.CancelFunc, *sync.WaitGroup) {
	t.Helper()
