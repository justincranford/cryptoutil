...
func TestWithTransaction(t *testing.T) {
	...
	txCtx := cryptoutilAppsFrameworkServiceServerRepository.WithTransaction(ctx, mockTx)
...
func TestGetDB_WithTransaction(t *testing.T) {
	...
	txCtx := cryptoutilAppsFrameworkServiceServerRepository.WithTransaction(ctx, mockTx)
	db := cryptoutilAppsFrameworkServiceServerRepository.GetDB(txCtx, baseDB)
...
func TestGetDB_WithoutTransaction(t *testing.T) {
	...
	db := cryptoutilAppsFrameworkServiceServerRepository.GetDB(ctx, baseDB)
...
func TestGetDB_NilTransaction(t *testing.T) {
	...
	txCtx := cryptoutilAppsFrameworkServiceServerRepository.WithTransaction(ctx, nil)
	db := cryptoutilAppsFrameworkServiceServerRepository.GetDB(txCtx, baseDB)
