...
func TestApplication_TableDriven_HappyPath(t *testing.T) {
	...
	tests := []struct {
		name        string
		description string
		testFunc    func(t *testing.T, app *cryptoutilAppsFrameworkServiceServer.Application)
	}{
		{
			name:        "NewApplication",
			description: "Verify successful application creation with valid servers",
			testFunc: func(t *testing.T, _ *cryptoutilAppsFrameworkServiceServer.Application) {
				t.Helper()

				ctx := context.Background()
				publicServer := cryptoutilAppsFrameworkServiceServerTestutil.NewMockPublicServer(cryptoutilSharedMagic.DemoServerPort)
...
func TestApplication_TableDriven_SadPath(t *testing.T) {
	...
	tests := []struct {
		name          string
		description   string
		setupFunc     func(t *testing.T) (*cryptoutilAppsFrameworkServiceServer.Application, error)
		...
		},
		{
			...
			setupFunc: func(t *testing.T) (*cryptoutilAppsFrameworkServiceServer.Application, error) {
				...
				return cryptoutilAppsFrameworkServiceServer.NewApplication(ctx, publicServer, nil)
			},
		...
		},
		{
			...
			setupFunc: func(t *testing.T) (*cryptoutilAppsFrameworkServiceServer.Application, error) {
				...
				ctx := context.Background()
				publicServer := cryptoutilAppsFrameworkServiceServerTestutil.NewMockPublicServer(cryptoutilSharedMagic.DemoServerPort)
				adminServer := cryptoutilAppsFrameworkServiceServerTestutil.NewMockAdminServer(0) // Port 0 returns 0.
