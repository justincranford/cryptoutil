...
func (r *tenantJoinRequestRepository) Create(ctx context.Context, request *cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest) error {
...
func (r *tenantJoinRequestRepository) Update(ctx context.Context, request *cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest) error {
...
func (r *tenantJoinRequestRepository) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest, error) {
	var request cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest
...
func (r *tenantJoinRequestRepository) ListByTenant(ctx context.Context, tenantID googleUuid.UUID) ([]*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest, error) {
	var requests []*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest
...
func (r *tenantJoinRequestRepository) ListByStatus(ctx context.Context, status string) ([]*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest, error) {
	var requests []*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest
...
func (r *tenantJoinRequestRepository) ListByTenantAndStatus(ctx context.Context, tenantID googleUuid.UUID, status string) ([]*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest, error) {
	var requests []*cryptoutilAppsFrameworkServiceServerDomain.TenantJoinRequest
