...
func TestClient_IsActive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			client := &cryptoutilAppsFrameworkServiceServerRepository.Client{Active: tt.active}
...
func TestUnverifiedUser_IsExpired(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			user := &cryptoutilAppsFrameworkServiceServerRepository.UnverifiedUser{ExpiresAt: tt.expiresAt}
...
func TestUnverifiedClient_IsExpired(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			client := &cryptoutilAppsFrameworkServiceServerRepository.UnverifiedClient{ExpiresAt: tt.expiresAt}
...
func TestTenantRealm_TableName(t *testing.T) {
	...
	tenantRealm := cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{}
