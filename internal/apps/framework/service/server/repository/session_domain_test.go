...
func TestBrowserSessionJWK_TableName(t *testing.T) {
	...
	jwk := cryptoutilAppsFrameworkServiceServerRepository.BrowserSessionJWK{}
...
func TestServiceSessionJWK_TableName(t *testing.T) {
	...
	jwk := cryptoutilAppsFrameworkServiceServerRepository.ServiceSessionJWK{}
...
func TestBrowserSession_TableName(t *testing.T) {
	...
	session := cryptoutilAppsFrameworkServiceServerRepository.BrowserSession{}
...
func TestServiceSession_TableName(t *testing.T) {
	...
	session := cryptoutilAppsFrameworkServiceServerRepository.ServiceSession{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			browserSession := &cryptoutilAppsFrameworkServiceServerRepository.BrowserSession{
				Session: cryptoutilAppsFrameworkServiceServerRepository.Session{Expiration: tt.expiration},
			}
