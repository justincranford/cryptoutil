...
func TestTenant_IsActive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tenant := &cryptoutilAppsFrameworkServiceServerRepository.Tenant{Active: tt.active}
...
func TestUser_GetID(t *testing.T) {
	...
	id := googleUuid.New()
	user := &cryptoutilAppsFrameworkServiceServerRepository.User{ID: id}
...
func TestUser_GetUsername(t *testing.T) {
	...
	user := &cryptoutilAppsFrameworkServiceServerRepository.User{Username: "testuser"}
...
func TestUser_GetPasswordHash(t *testing.T) {
	...
	user := &cryptoutilAppsFrameworkServiceServerRepository.User{PasswordHash: "hash123"}
...
func TestUser_GetTenantID(t *testing.T) {
	...
	user := &cryptoutilAppsFrameworkServiceServerRepository.User{TenantID: tenantID}
...
func TestUser_IsActive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			user := &cryptoutilAppsFrameworkServiceServerRepository.User{Active: tt.active}
...
func TestTenantRealm_GetRealmID(t *testing.T) {
	...
	tr := &cryptoutilAppsFrameworkServiceServerRepository.TenantRealm{
		RealmID: realmID,
	}
