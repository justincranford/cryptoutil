...
func TestNewMigrationRunner(t *testing.T) {
	...
	runner := cryptoutilAppsFrameworkServiceServerRepository.NewMigrationRunner(testMigrationsFS, "test_migrations")
...
func TestMigrationRunner_Apply_SQLite(t *testing.T) {
	...
	runner := cryptoutilAppsFrameworkServiceServerRepository.NewMigrationRunner(testMigrationsFS, "test_migrations")
	err = runner.Apply(db, cryptoutilAppsFrameworkServiceServerRepository.DatabaseTypeSQLite)
...
func TestMigrationRunner_Apply_InvalidPath(t *testing.T) {
	...
	runner := cryptoutilAppsFrameworkServiceServerRepository.NewMigrationRunner(testMigrationsFS, "nonexistent")
	err = runner.Apply(db, cryptoutilAppsFrameworkServiceServerRepository.DatabaseTypeSQLite)
...
func TestMigrationRunner_Apply_UnsupportedDatabaseType(t *testing.T) {
	...
	runner := cryptoutilAppsFrameworkServiceServerRepository.NewMigrationRunner(testMigrationsFS, "test_migrations")
	err = runner.Apply(db, cryptoutilAppsFrameworkServiceServerRepository.DatabaseType("unsupported"))
...
func TestApplyMigrationsFromFS_SQLite(t *testing.T) {
	...
	err = cryptoutilAppsFrameworkServiceServerRepository.ApplyMigrationsFromFS(db, testMigrationsFS, "test_migrations", cryptoutilSharedMagic.TestDatabaseSQLite)
	require.NoError(t, err)
}
...
func TestApplyMigrationsFromFS_Sqlite3(t *testing.T) {
	...
	err = cryptoutilAppsFrameworkServiceServerRepository.ApplyMigrationsFromFS(db, testMigrationsFS, "test_migrations", "sqlite3")
	require.NoError(t, err)
}
...
func TestApplyMigrationsFromFS_UnsupportedType(t *testing.T) {
	...
	err = cryptoutilAppsFrameworkServiceServerRepository.ApplyMigrationsFromFS(db, testMigrationsFS, "test_migrations", "mysql")
	require.Error(t, err)
	require.Contains(t, err.Error(), "unsupported database type")
}
