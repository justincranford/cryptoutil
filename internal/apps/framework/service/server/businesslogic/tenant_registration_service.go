...
type TenantRegistrationService struct {
	...
	joinRequestRepo cryptoutilAppsFrameworkServiceServerRepository.TenantJoinRequestRepository
}
...
func (s *TenantRegistrationService) RegisterUserWithTenant(
	...
	tenantName string,
	createTenant bool,
) (*cryptoutilAppsFrameworkServiceServerRepository.Tenant, error) {
	if createTenant {
...
func (s *TenantRegistrationService) AuthorizeJoinRequest(
	...
	if joinRequest.Status != cryptoutilAppsFrameworkServiceServerDomain.JoinRequestStatusPending {
