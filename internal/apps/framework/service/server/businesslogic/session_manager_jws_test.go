...
func TestSessionManager_JWS_ExpiredSession(t *testing.T) {
	...
	var session cryptoutilAppsFrameworkServiceServerRepository.BrowserSession
...
func TestSessionManager_JWE_ExpiredSession(t *testing.T) {
	...
	deleteErr := sm.db.Where("user_id = ?", userID).Delete(&cryptoutilAppsFrameworkServiceServerRepository.BrowserSession{}).Error
...
func TestSessionManager_CleanupExpiredSessions(t *testing.T) {
	...
	updateErr := sm.db.Model(&cryptoutilAppsFrameworkServiceServerRepository.BrowserSession{}).
