...
func (m *mockSessionValidator) ValidateBrowserSession(_ context.Context, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.BrowserSession, error) {
	return m.browserSession, m.browserSessionErr
}

func (m *mockSessionValidator) ValidateServiceSession(_ context.Context, _ string) (*cryptoutilAppsFrameworkServiceServerRepository.ServiceSession, error) {
