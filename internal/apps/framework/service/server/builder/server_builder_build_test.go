...
func TestBuild_AdminServerCreateError(t *testing.T) {
	...
	newAdminHTTPServerFn = func(
		_ context.Context,
		_ *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings,
		_ *cryptoutilAppsFrameworkServiceConfigTlsGenerator.TLSGeneratedSettings,
...
func TestBuild_InitServicesError(t *testing.T) {
	...
	initServicesOnCoreFn = func(
		_ context.Context,
		_ *cryptoutilAppsFrameworkServiceServerApplication.Core,
		_ *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings,
...
func TestBuild_PublicServerBaseError(t *testing.T) {
	...
	newPublicServerBaseFn = func(
		_ *cryptoutilAppsFrameworkServiceServer.PublicServerConfig,
...
func TestBuild_NewApplicationError(t *testing.T) {
	...
	newApplicationFn = func(
		_ context.Context,
		_ cryptoutilAppsFrameworkServiceServer.IPublicServer,
		_ cryptoutilAppsFrameworkServiceServer.IAdminServer,
...
func TestBuild_GormDBError(t *testing.T) {
	...
	startCoreFn = func(
		...
		return &cryptoutilAppsFrameworkServiceServerApplication.Core{
			DB:                  fakeDB,
			Basic:               &cryptoutilAppsFrameworkServiceServerApplication.Basic{},
