...
type ServiceResources struct {
	...
	// Application wrapper.
	Application *cryptoutilAppsFrameworkServiceServer.Application
...
type ServerBuilder struct {
	...
	publicRouteRegister func(*cryptoutilAppsFrameworkServiceServer.PublicServerBase, *ServiceResources) error
...
func NewServerBuilder(ctx context.Context, config *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings) *ServerBuilder {
	if ctx == nil {
...
func (b *ServerBuilder) WithPublicRouteRegistration(registerFunc func(*cryptoutilAppsFrameworkServiceServer.PublicServerBase, *ServiceResources) error) *ServerBuilder {
	if b.err != nil {
		return b
	}
