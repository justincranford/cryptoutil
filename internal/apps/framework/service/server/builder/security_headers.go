...
func NewDefaultSecurityHeadersConfig(settings *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings) *SecurityHeadersConfig {
...
func buildContentSecurityPolicy(settings *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings) string {
...
func isNonBrowserAPIRequest(settings *cryptoutilAppsFrameworkServiceConfig.ServiceFrameworkServerSettings) func(*fiber.Ctx) bool {
