...
func TestNewService_NilParameters(t *testing.T) {
	...
	tests := []struct {
		...
		repo                cryptoutilAppsFrameworkServiceServerBarrier.Repository
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			svc, err := cryptoutilAppsFrameworkServiceServerBarrier.NewService(tc.ctx, tc.telemetrySvc, tc.jwkGenSvc, tc.repo, tc.unsealSvc)
			require.Error(t, err)
			require.Nil(t, svc)
...
func TestRotationService_RotateRootKey_NoExistingKey(t *testing.T) {
	...
	rotationSvc, err := cryptoutilAppsFrameworkServiceServerBarrier.NewRotationService(jwkGenSvc, repo, unsealSvc)
	require.NoError(t, err)
