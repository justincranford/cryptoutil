...
func TestNewRootKeysService_ValidationErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service, err := cryptoutilAppsFrameworkServiceServerBarrier.NewRootKeysService(
				tt.telemetryService,
				tt.jwkGenService,
				tt.repository,
...
func TestNewIntermediateKeysService_ValidationErrors(t *testing.T) {
	...
	tests := []struct {
		...
		jwkGenService      *cryptoutilSharedCryptoJose.JWKGenService
		repository         cryptoutilAppsFrameworkServiceServerBarrier.Repository
		rootKeysService    *cryptoutilAppsFrameworkServiceServerBarrier.RootKeysService
		expectedErrContain string
	}{
		{
			name:               "nil telemetry service",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service, err := cryptoutilAppsFrameworkServiceServerBarrier.NewIntermediateKeysService(
				tt.telemetryService,
				tt.jwkGenService,
				tt.repository,
				tt.rootKeysService,
...
func TestNewContentKeysService_ValidationErrors(t *testing.T) {
	...
	tests := []struct {
		...
		jwkGenService           *cryptoutilSharedCryptoJose.JWKGenService
		repository              cryptoutilAppsFrameworkServiceServerBarrier.Repository
		intermediateKeysService *cryptoutilAppsFrameworkServiceServerBarrier.IntermediateKeysService
		expectedErrContain      string
	}{
		{
			name:                    "nil telemetry service",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service, err := cryptoutilAppsFrameworkServiceServerBarrier.NewContentKeysService(
				tt.telemetryService,
				tt.jwkGenService,
				tt.repository,
...
func TestRootKeysService_Shutdown(t *testing.T) {
	...
	service, err := cryptoutilAppsFrameworkServiceServerBarrier.NewRootKeysService(telemetrySvc, jwkGenSvc, repo, unsealSvc)
	require.NoError(t, err)
...
func TestIntermediateKeysService_Shutdown(t *testing.T) {
	...
	service, err := cryptoutilAppsFrameworkServiceServerBarrier.NewIntermediateKeysService(telemetrySvc, jwkGenSvc, repo, rootKeysSvc)
	require.NoError(t, err)
