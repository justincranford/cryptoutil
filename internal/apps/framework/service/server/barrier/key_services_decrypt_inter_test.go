...
func TestIntermediateKeysService_DecryptKey_ErrorPaths(t *testing.T) {
	...
	tests := []struct {
		name               string
		setupFunc          func(t *testing.T) (cryptoutilAppsFrameworkServiceServerBarrier.Transaction, *cryptoutilAppsFrameworkServiceServerBarrier.IntermediateKeysService, []byte)
	...
	}{
		{
			...
			setupFunc: func(t *testing.T) (cryptoutilAppsFrameworkServiceServerBarrier.Transaction, *cryptoutilAppsFrameworkServiceServerBarrier.IntermediateKeysService, []byte) {
				...
				var tx cryptoutilAppsFrameworkServiceServerBarrier.Transaction

				err = repo.WithTransaction(ctx, func(transaction cryptoutilAppsFrameworkServiceServerBarrier.Transaction) error {
					tx = transaction
...
func TestRootKeysService_DecryptKey_AdditionalErrorPaths(t *testing.T) {
	...
	tests := []struct {
		name               string
		setupFunc          func(t *testing.T) (cryptoutilAppsFrameworkServiceServerBarrier.Transaction, *cryptoutilAppsFrameworkServiceServerBarrier.RootKeysService, []byte)
		expectedErrContain string
	}{
		{
			name: "key_not_found",
			setupFunc: func(t *testing.T) (cryptoutilAppsFrameworkServiceServerBarrier.Transaction, *cryptoutilAppsFrameworkServiceServerBarrier.RootKeysService, []byte) {
				...
				_ = repo.WithTransaction(ctx, func(txInner cryptoutilAppsFrameworkServiceServerBarrier.Transaction) error {
					tx = txInner
