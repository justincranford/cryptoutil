...
func TestNewUnsealKeysServiceFromSettings_MofN_FileMismatch(t *testing.T) {
	...
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-mofn-file-mismatch")
...
func TestNewUnsealKeysServiceFromSettings_MofN_HappyPath(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-mofn-happy")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_SimpleMode_HappyPath(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-simple-mode-happy")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_SimpleMode_InvalidJWK(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-simple-mode-invalid-jwk")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_MofN_ReadFilesError(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-mofn-read-error")
	settings.DevMode = false
	settings.UnsealMode = testUnsealMode2Of3
...
func TestNewUnsealKeysServiceFromSettings_SimpleMode_ReadFilesError(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-simple-read-error")
	settings.DevMode = false
...
func TestUnsealKeysServiceFromSettings_InterfaceMethods(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-interface-methods")
