...
func createTestContext(t *testing.T) (context.Context, *cryptoutilSharedTelemetry.TelemetryService) {
	...
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("unsealkeysservice-test")
...
func TestNewUnsealKeysServiceFromSettings_DevMode(t *testing.T) {
	...
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-dev-mode")
...
func TestNewUnsealKeysServiceFromSettings_InvalidMofNFormat(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-invalid-mofn")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidMValue(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-invalid-m")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidNValue(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-invalid-n")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_MZeroBoundary(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-m-zero-boundary")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidMNValues(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ctx, telemetryService := createTestContext(t)
			settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-invalid-mn-" + tc.name)
			settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_InvalidSimpleMode(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-invalid-simple")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_ZeroSimpleMode(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-zero-simple")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_MissingFiles(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-missing-files")
	settings.DevMode = false
...
func TestNewUnsealKeysServiceFromSettings_FileMismatch(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-file-mismatch")
	settings.DevMode = false
...
func TestUnsealKeysServiceFromSettings_EncryptDecrypt(t *testing.T) {
	...
	ctx, telemetryService := createTestContext(t)
	settings := cryptoutilAppsFrameworkServiceConfig.RequireNewForTest("test-encrypt-decrypt")
	settings.DevMode = true
