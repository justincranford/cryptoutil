...
func TestRootKeysService_EncryptKey_ErrorPaths(t *testing.T) {
	...
	tests := []struct {
		name    string
		setup   func(*testing.T) (*cryptoutilAppsFrameworkServiceServerBarrier.RootKeysService, cryptoutilAppsFrameworkServiceServerBarrier.Repository, *cryptoutilSharedCryptoJose.JWKGenService)
		wantErr string
	}{
		{
			name: "decrypt_root_key_failure",
			setup: func(t *testing.T) (*cryptoutilAppsFrameworkServiceServerBarrier.RootKeysService, cryptoutilAppsFrameworkServiceServerBarrier.Repository, *cryptoutilSharedCryptoJose.JWKGenService) {
