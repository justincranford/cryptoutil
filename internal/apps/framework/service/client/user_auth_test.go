...
func TestRegisterServiceUser_Success(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterServiceUser(server.Client(), server.URL, "testuser", "testpass")
...
func TestRegisterServiceUser_RegistrationFails(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterServiceUser(server.Client(), server.URL, "existing", "pass")
...
func TestRegisterBrowserUser_Success(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterBrowserUser(server.Client(), server.URL, "browseruser", "browserpass")
...
func TestLoginUser_Success(t *testing.T) {
	...
	token, err := cryptoutilAppsFrameworkServiceClient.LoginUser(server.Client(), server.URL, "/custom/login", "user", "pass")
...
func TestLoginUser_InvalidCredentials(t *testing.T) {
	...
	token, err := cryptoutilAppsFrameworkServiceClient.LoginUser(server.Client(), server.URL, "/login", "wrong", "creds")
...
func TestLoginUser_MissingToken(t *testing.T) {
	...
	token, err := cryptoutilAppsFrameworkServiceClient.LoginUser(server.Client(), server.URL, "/login", "user", "pass")
...
func TestRegisterTestUserService_Success(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterTestUserService(server.Client(), server.URL)
...
func TestRegisterTestUserBrowser_Success(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterTestUserBrowser(server.Client(), server.URL)
...
func TestSendAuthenticatedRequest_Success(t *testing.T) {
	...
	body := []byte(`{"key":"value"}`)
	resp, err := cryptoutilAppsFrameworkServiceClient.SendAuthenticatedRequest(server.Client(), http.MethodPost, server.URL+"/api", "test-token", body)
...
func TestSendAuthenticatedRequest_NoBody(t *testing.T) {
	...
	resp, err := cryptoutilAppsFrameworkServiceClient.SendAuthenticatedRequest(server.Client(), http.MethodGet, server.URL+"/data", "token123", nil)
...
func TestDecodeJSONResponse_Success(t *testing.T) {
	...
	err := cryptoutilAppsFrameworkServiceClient.DecodeJSONResponse(resp, &target)
