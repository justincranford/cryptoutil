...
func TestRegisterServiceUser_ConnectionError(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterServiceUser(client, "http://127.0.0.1:59999", "user", "pass")
...
func TestRegisterBrowserUser_ConnectionError(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterBrowserUser(client, "http://127.0.0.1:59999", "user", "pass")
...
func TestLoginUser_ConnectionError(t *testing.T) {
	...
	token, err := cryptoutilAppsFrameworkServiceClient.LoginUser(client, "http://127.0.0.1:59999", "/login", "user", "pass")
...
func TestSendAuthenticatedRequest_ConnectionError(t *testing.T) {
	...
	resp, err := cryptoutilAppsFrameworkServiceClient.SendAuthenticatedRequest(client, http.MethodGet, "http://127.0.0.1:59999/api", cryptoutilSharedMagic.ParamToken, nil) //nolint:bodyclose // resp is nil on connection error.
...
func TestVerifyHealthEndpoint_ConnectionError(t *testing.T) {
	...
	err := cryptoutilAppsFrameworkServiceClient.VerifyHealthEndpoint(client, "http://127.0.0.1:59999", "/health")
...
func TestRegisterServiceUser_InvalidURL(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterServiceUser(client, "http://invalid\x00url", "user", "pass")
...
func TestRegisterBrowserUser_InvalidURL(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterBrowserUser(client, "http://invalid\x00url", "user", "pass")
...
func TestLoginUser_InvalidURL(t *testing.T) {
	...
	token, err := cryptoutilAppsFrameworkServiceClient.LoginUser(client, "http://invalid\x00url", "/login", "user", "pass")
...
func TestSendAuthenticatedRequest_InvalidURL(t *testing.T) {
	...
	resp, err := cryptoutilAppsFrameworkServiceClient.SendAuthenticatedRequest(client, http.MethodGet, "http://invalid\x00url/api", cryptoutilSharedMagic.ParamToken, nil) //nolint:bodyclose // resp is nil on invalid URL.
...
func TestVerifyHealthEndpoint_InvalidURL(t *testing.T) {
	...
	err := cryptoutilAppsFrameworkServiceClient.VerifyHealthEndpoint(client, "http://invalid\x00url", "/health")
