...
func TestGetUserIDFromResponse_Success(t *testing.T) {
	...
	userID, err := cryptoutilAppsFrameworkServiceClient.GetUserIDFromResponse(respBody)
...
func TestVerifyHealthEndpoint_Success(t *testing.T) {
	...
	err := cryptoutilAppsFrameworkServiceClient.VerifyHealthEndpoint(server.Client(), server.URL, cryptoutilSharedMagic.IdentityE2EHealthEndpoint)
...
func TestVerifyHealthEndpoint_UnhealthyStatus(t *testing.T) {
	...
	err := cryptoutilAppsFrameworkServiceClient.VerifyHealthEndpoint(server.Client(), server.URL, "/health")
...
func TestRegisterBrowserUser_RegistrationFails(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterBrowserUser(server.Client(), server.URL, "existing", "pass")
...
func TestRegisterBrowserUser_InvalidUserIDInResponse(t *testing.T) {
	...
	user, err := cryptoutilAppsFrameworkServiceClient.RegisterBrowserUser(server.Client(), server.URL, "testuser", "testpass")
