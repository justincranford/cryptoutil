...
var testServiceCfg = cryptoutilAppsFrameworkCli.ServiceConfig{ //nolint:gochecknoglobals // test fixture
...
func TestRouteService_EmptyArgsDefaultsToServer(t *testing.T) {
	...
	exitCode := cryptoutilAppsFrameworkCli.RouteService(testServiceCfg, nil, &stdout, &stderr, serverFn, noopSubcmd, noopSubcmd)
...
func TestRouteService_HelpFlag(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			exitCode := cryptoutilAppsFrameworkCli.RouteService(testServiceCfg, []string{tt.arg}, &stdout, &stderr, noopSubcmd, noopSubcmd, noopSubcmd)
			require.Equal(t, 0, exitCode)
...
func TestRouteService_ClientSubcommand(t *testing.T) {
	...
	exitCode := cryptoutilAppsFrameworkCli.RouteService(testServiceCfg, []string{"client"}, &stdout, &stderr, noopSubcmd, clientFn, noopSubcmd)
...
func TestRouteService_InitSubcommand(t *testing.T) {
	...
	exitCode := cryptoutilAppsFrameworkCli.RouteService(testServiceCfg, []string{"init"}, &stdout, &stderr, noopSubcmd, noopSubcmd, initFn)
...
func TestRouteService_UnknownSubcommand(t *testing.T) {
	...
	exitCode := cryptoutilAppsFrameworkCli.RouteService(testServiceCfg, []string{"banana"}, &stdout, &stderr, noopSubcmd, noopSubcmd, noopSubcmd)
