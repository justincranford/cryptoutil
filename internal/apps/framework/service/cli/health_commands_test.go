...
func TestLivezCommand_HelpFlag(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			exitCode := cryptoutilAppsFrameworkCli.LivezCommand([]string{tt.arg}, &stdout, &stderr, "Usage: livez")
			require.Equal(t, 0, exitCode)
...
func TestReadyzCommand_HelpFlag(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			exitCode := cryptoutilAppsFrameworkCli.ReadyzCommand([]string{tt.arg}, &stdout, &stderr, "Usage: readyz")
			require.Equal(t, 0, exitCode)
...
func TestShutdownCommand_HelpFlag(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			exitCode := cryptoutilAppsFrameworkCli.ShutdownCommand([]string{tt.arg}, &stdout, &stderr, "Usage: shutdown")
			require.Equal(t, 0, exitCode)
