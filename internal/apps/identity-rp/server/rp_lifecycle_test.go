...
// TestRPServer_StartupShutdown verifies server startup and graceful shutdown.
func TestRPServer_StartupShutdown(t *testing.T) {
	t.Parallel()

	ctx := context.Background()
	cfg := cryptoutilAppsIdentityRpServerConfig.DefaultTestConfig()
