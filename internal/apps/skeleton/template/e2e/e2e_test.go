...
// TestE2E_HealthChecks validates /health endpoint for all skeleton-template instances.
...
healthURL := tt.publicURL + cryptoutilSharedMagic.SkeletonTemplateE2EHealthEndpoint
