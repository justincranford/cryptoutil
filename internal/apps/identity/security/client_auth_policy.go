...
func DefaultClientAuthPolicy() *ClientAuthPolicy {
	return &ClientAuthPolicy{
		...
		AllowedJWTAlgorithms:         []string{cryptoutilSharedMagic.DefaultBrowserSessionJWSAlgorithm, cryptoutilSharedMagic.JoseAlgRS384, cryptoutilSharedMagic.JoseAlgRS512, cryptoutilSharedMagic.JoseAlgES256, cryptoutilSharedMagic.JoseAlgES384, cryptoutilSharedMagic.JoseAlgES512},
...
func StrictClientAuthPolicy() *ClientAuthPolicy {
	return &ClientAuthPolicy{
		...
		RequireMTLS:                  true,
		RequireJWTSignature:          true,
		AllowedJWTAlgorithms:         []string{cryptoutilSharedMagic.DefaultBrowserSessionJWSAlgorithm, cryptoutilSharedMagic.JoseAlgES256},
		RequireCertificateValidation: true,
		AllowSelfSignedCertificates:  false,
...
func DevelopmentClientAuthPolicy() *ClientAuthPolicy {
	return &ClientAuthPolicy{
		...
		RequireMTLS:                  false,
		RequireJWTSignature:          false,
		AllowedJWTAlgorithms:         []string{cryptoutilSharedMagic.DefaultBrowserSessionJWSAlgorithm, cryptoutilSharedMagic.JoseAlgRS384, cryptoutilSharedMagic.JoseAlgRS512, cryptoutilSharedMagic.JoseAlgES256, cryptoutilSharedMagic.JoseAlgES384, cryptoutilSharedMagic.JoseAlgES512, cryptoutilSharedMagic.JoseAlgHS256},
		RequireCertificateValidation: false,
