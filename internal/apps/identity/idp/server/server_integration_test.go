...
func TestIDPServer_Lifecycle(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestIDPServer_PortAllocation(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestIDPServer_TemplateServices(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestIDPServer_PublicHealth(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestIDPServer_AccessorMethods(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestIDPServer_ContractCompliance(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
