...
func TestSPAServer_Lifecycle(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestSPAServer_PortAllocation(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestSPAServer_TemplateServices(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestSPAServer_PublicHealth(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
...
func TestSPAServer_SPAFallback(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
	...
	// Any route should return the SPA placeholder (for client-side routing).
	url := testBaseURL + "/some/client/route"
	...
	// SPA fallback returns 200 OK with placeholder response.
	require.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestSPAServer_APINotFound(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
	...
	// API routes should return 404 (not SPA fallback).
	url := testBaseURL + "/api/unknown"
	...
	// API routes should return 404 Not Found.
	require.Equal(t, http.StatusNotFound, resp.StatusCode)
}

func TestSPAServer_AccessorMethods(t *testing.T) {
	t.Parallel()
	requireTestSetup(t)
