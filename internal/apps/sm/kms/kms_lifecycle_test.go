...
// TestKMS_ServerLifecycle verifies the full server start → signal → graceful shutdown path.
...
func TestKMS_ServerLifecycle(t *testing.T) {
	...
	require.Contains(t, combined, "sm-kms service stopped")
}
