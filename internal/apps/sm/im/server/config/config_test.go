...
func TestDefaultTestConfig(t *testing.T) {
	...
	require.Equal(t, cryptoutilSharedMagic.IMRecipientsMinCount, settings.RecipientsMinCount)
	require.Equal(t, cryptoutilSharedMagic.IMRecipientsMaxCount, settings.RecipientsMaxCount)
...
func TestNewTestConfig_CustomValues(t *testing.T) {
	...
	settings := cryptoutilAppsSmImServerConfig.NewTestConfig(bindAddr, bindPort, devMode)
...
func TestNewTestConfig_OTLPServiceOverride(t *testing.T) {
	...
	settings := cryptoutilAppsSmImServerConfig.NewTestConfig(cryptoutilSharedMagic.IPv4Loopback, 0, true)
...
func TestNewTestConfig_ZeroValue(t *testing.T) {
	...
	settings := cryptoutilAppsSmImServerConfig.NewTestConfig(cryptoutilSharedMagic.IPv4Loopback, 0, false)
	...
	// Sm-im defaults still populated.
...
func TestDefaultTestConfig_PortAllocation(t *testing.T) {
	...
	settings1 := cryptoutilAppsSmImServerConfig.DefaultTestConfig()
	settings2 := cryptoutilAppsSmImServerConfig.DefaultTestConfig()
...
func TestParse_HappyPath(t *testing.T) {
	...
	// Parse uses template defaults for sm-im settings since flags can't be tested directly
	...
	settings, err := cryptoutilAppsSmImServerConfig.Parse(args, false)
...
// would require exporting validateSmIMSettings() or using reflection.
