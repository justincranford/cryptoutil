...
func TestNewPublicServer_NilContext(t *testing.T) {
	...
	_, err := server.NewPublicServer(context.Background(), 0, userRepo, messageRepo, messageRecipientJWKRepo, nil, nil, nil, "test-secret", testTLSCfg)
	require.Error(t, err)
...
func TestNewPublicServer_NilUserRepo(t *testing.T) {
	...
	_, err := server.NewPublicServer(ctx, 0, nil, messageRepo, messageRecipientJWKRepo, nil, nil, nil, "test-secret", testTLSCfg)
	require.Error(t, err)
...
func TestNewPublicServer_NilMessageRepo(t *testing.T) {
	...
	_, err := server.NewPublicServer(ctx, 0, userRepo, nil, messageRecipientJWKRepo, nil, nil, nil, "test-secret", testTLSCfg)
	require.Error(t, err)
...
func TestNewPublicServer_NilMessageRecipientJWKRepo(t *testing.T) {
	...
	_, err := server.NewPublicServer(ctx, 0, userRepo, messageRepo, nil, nil, nil, nil, "test-secret", testTLSCfg)
	require.Error(t, err)
...
func TestNewPublicServer_NilTLSConfig(t *testing.T) {
	...
	_, err := server.NewPublicServer(ctx, 0, userRepo, messageRepo, messageRecipientJWKRepo, testJWKGenService, nil, sessionManager, "test-secret", nil)
	require.Error(t, err)
