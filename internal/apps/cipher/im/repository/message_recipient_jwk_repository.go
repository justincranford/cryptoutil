...
func (r *MessageRecipientJWKRepository) Create(ctx context.Context, messageRecipientJWK *cryptoutilAppsCipherImDomain.MessageRecipientJWK) error {
...
func (r *MessageRecipientJWKRepository) FindByRecipientAndMessage(ctx context.Context, recipientID, messageID googleUuid.UUID) (*cryptoutilAppsCipherImDomain.MessageRecipientJWK, error) {
	var messageRecipientJWK cryptoutilAppsCipherImDomain.MessageRecipientJWK
...
func (r *MessageRecipientJWKRepository) FindByMessageID(ctx context.Context, messageID googleUuid.UUID) ([]cryptoutilAppsCipherImDomain.MessageRecipientJWK, error) {
	var messageRecipientJWKs []cryptoutilAppsCipherImDomain.MessageRecipientJWK
...
func (r *MessageRecipientJWKRepository) Delete(ctx context.Context, id googleUuid.UUID) error {
	if err := cryptoutilAppsTemplateServiceServerRepository.GetDB(ctx, r.db).WithContext(ctx).Delete(&cryptoutilAppsCipherImDomain.MessageRecipientJWK{}, "id = ?", id).Error; err != nil {
...
func (r *MessageRecipientJWKRepository) DeleteByMessageID(ctx context.Context, messageID googleUuid.UUID) error {
	if err := cryptoutilAppsTemplateServiceServerRepository.GetDB(ctx, r.db).WithContext(ctx).
		Where("message_id = ?", messageID).
		Delete(&cryptoutilAppsCipherImDomain.MessageRecipientJWK{}).Error; err != nil {
