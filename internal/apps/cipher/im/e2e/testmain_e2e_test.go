...
var (
	...
	postgres1PublicURL = fmt.Sprintf("https://127.0.0.1:%d", cryptoutilSharedMagic.CipherE2EPostgreSQL1PublicPort) // "https://127.0.0.1:8701"
	postgres2PublicURL = fmt.Sprintf("https://127.0.0.1:%d", cryptoutilSharedMagic.CipherE2EPostgreSQL2PublicPort) // "https://127.0.0.1:8702"
...
func TestMain(m *testing.M) {
	...
	composeManager = cryptoutilAppsTemplateTestingE2eInfra.NewComposeManager(cryptoutilSharedMagic.CipherE2EComposeFile)
