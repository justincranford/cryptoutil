...
type AuditLogService interface {
	...
	ListAuditLogs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error)

	// ListAuditLogsByElasticJWK lists audit logs for a specific elastic JWK.
	ListAuditLogsByElasticJWK(ctx context.Context, tenantID, elasticJWKID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error)

	// ListAuditLogsByOperation lists audit logs by operation type.
	ListAuditLogsByOperation(ctx context.Context, tenantID googleUuid.UUID, operation string, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error)

	// GetAuditConfig gets the audit configuration for a tenant.
	GetAuditConfig(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsJoseJaModel.AuditConfig, error)

	// UpdateAuditConfig updates the audit configuration for a tenant.
	UpdateAuditConfig(ctx context.Context, tenantID googleUuid.UUID, config *cryptoutilAppsJoseJaModel.AuditConfig) error
...
// ListAuditLogs lists audit logs for a tenant with pagination.
func (s *auditLogServiceImpl) ListAuditLogs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error) {
...
// ListAuditLogsByElasticJWK lists audit logs for a specific elastic JWK.
func (s *auditLogServiceImpl) ListAuditLogsByElasticJWK(ctx context.Context, tenantID, elasticJWKID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error) {
...
// ListAuditLogsByOperation lists audit logs by operation type.
func (s *auditLogServiceImpl) ListAuditLogsByOperation(ctx context.Context, tenantID googleUuid.UUID, operation string, offset, limit int) ([]*cryptoutilAppsJoseJaModel.AuditLogEntry, int64, error) {
...
// GetAuditConfig gets the audit configuration for a tenant.
func (s *auditLogServiceImpl) GetAuditConfig(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsJoseJaModel.AuditConfig, error) {
	...
	return &cryptoutilAppsJoseJaModel.AuditConfig{
		TenantID:     tenantID,
		Operation:    cryptoutilAppsJoseJaModel.OperationGenerate, // Default operation.
		Enabled:      true,
...
// UpdateAuditConfig updates the audit configuration for a tenant.
func (s *auditLogServiceImpl) UpdateAuditConfig(ctx context.Context, tenantID googleUuid.UUID, config *cryptoutilAppsJoseJaModel.AuditConfig) error {
