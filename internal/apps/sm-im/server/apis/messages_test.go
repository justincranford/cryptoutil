...
var (
	...
	testMessageRepo    *cryptoutilAppsSmImRepository.MessageRepository
	testRecipientRepo  *cryptoutilAppsSmImRepository.MessageRecipientJWKRepository
...
func TestMain(m *testing.M) {
	...
	if err := cryptoutilAppsSmImRepository.ApplySmIMMigrations(testSQLDB, cryptoutilAppsSmImRepository.DatabaseTypeSQLite); err != nil {
	...
	barrierService, err := cryptoutilAppsFrameworkServiceServerBarrier.NewService(ctx, testTelemetryService, jwkGenService, barrierRepo, unsealKeysService)
	if err != nil {
	...
	testMessageRepo = cryptoutilAppsSmImRepository.NewMessageRepository(db)
	testRecipientRepo = cryptoutilAppsSmImRepository.NewMessageRecipientJWKRepository(db, barrierService)
