...
func TestServer_AccessorMethods(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			accessorFn: func() any { return testSmIMServer.DB() },
		},
		{
			name:       "App() returns non-nil Application",
			accessorFn: func() any { return testSmIMServer.App() },
		},
		{
			name:       "JWKGen() returns non-nil JWK generation service",
			accessorFn: func() any { return testSmIMServer.JWKGen() },
		},
		{
			name:       "Telemetry() returns non-nil telemetry service",
			accessorFn: func() any { return testSmIMServer.Telemetry() },
		},
		{
			name:       "PublicPort() returns valid port number",
			accessorFn: func() any { return testSmIMServer.PublicPort() },
		},
		{
			name:       "AdminPort() returns valid port number",
			accessorFn: func() any { return testSmIMServer.AdminPort() },
		},
		{
			name:       "PublicBaseURL() returns non-empty URL",
			accessorFn: func() any { return testSmIMServer.PublicBaseURL() },
		},
		{
		...
		},
		{
			...
			accessorFn: func() any { return testSmIMServer.RealmService() },
		},
		{
			name:       "RegistrationService() returns non-nil registration service",
			accessorFn: func() any { return testSmIMServer.RegistrationService() },
		},
		{
			name:       "BarrierService() returns non-nil barrier service",
			accessorFn: func() any { return testSmIMServer.BarrierService() },
		},
		{
			name:       "UserRepo() returns non-nil user repository",
			accessorFn: func() any { return testSmIMServer.UserRepo() },
		},
		{
			name:       "MessageRepo() returns non-nil message repository",
			accessorFn: func() any { return testSmIMServer.MessageRepo() },
		},
		{
			name:       "MessageRecipientJWKRepo() returns non-nil message recipient JWK repository",
			accessorFn: func() any { return testSmIMServer.MessageRecipientJWKRepo() },
		},
		{
			name:       "PublicServerBase() returns non-nil public server base",
			accessorFn: func() any { return testSmIMServer.PublicServerBase() },
		},
	}
...
func TestServer_Shutdown(t *testing.T) {
	...
	testServer, err := cryptoutilAppsSmImServer.NewIMServerFromConfig(startCtx, cfg)
...
func TestServer_Start_WithInvalidContext(t *testing.T) {
	...
	testServer, err := cryptoutilAppsSmImServer.NewIMServerFromConfig(ctx, cfg)
	require.NoError(t, err, "Failed to create test server")
	require.NotNil(t, testServer, "Server should not be nil")
...
func TestNewFromConfig_WithNilContext(t *testing.T) {
	...
	testServer, err := cryptoutilAppsSmImServer.NewIMServerFromConfig(nil, cfg) //nolint:staticcheck // SA1012: Intentionally testing nil context handling
...
func TestNewFromConfig_WithNilConfig(t *testing.T) {
	...
	testServer, err := cryptoutilAppsSmImServer.NewIMServerFromConfig(ctx, nil)
