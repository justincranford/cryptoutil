...
func (r *MessageRecipientJWKRepository) Create(ctx context.Context, messageRecipientJWK *cryptoutilAppsSmKmsModel.MessageRecipientJWK) error {
...
func (r *MessageRecipientJWKRepository) FindByRecipientAndMessage(ctx context.Context, recipientID, messageID googleUuid.UUID) (*cryptoutilAppsSmKmsModel.MessageRecipientJWK, error) {
	var messageRecipientJWK cryptoutilAppsSmKmsModel.MessageRecipientJWK
...
func (r *MessageRecipientJWKRepository) FindByMessageID(ctx context.Context, messageID googleUuid.UUID) ([]cryptoutilAppsSmKmsModel.MessageRecipientJWK, error) {
	var messageRecipientJWKs []cryptoutilAppsSmKmsModel.MessageRecipientJWK
...
func (r *MessageRecipientJWKRepository) Delete(ctx context.Context, id googleUuid.UUID) error {
	if err := cryptoutilAppsFrameworkServiceServerRepository.GetDB(ctx, r.db).WithContext(ctx).Delete(&cryptoutilAppsSmKmsModel.MessageRecipientJWK{}, "id = ?", id).Error; err != nil {
...
func (r *MessageRecipientJWKRepository) DeleteByMessageID(ctx context.Context, messageID googleUuid.UUID) error {
	if err := cryptoutilAppsFrameworkServiceServerRepository.GetDB(ctx, r.db).WithContext(ctx).
		Where("message_id = ?", messageID).
		Delete(&cryptoutilAppsSmKmsModel.MessageRecipientJWK{}).Error; err != nil {
