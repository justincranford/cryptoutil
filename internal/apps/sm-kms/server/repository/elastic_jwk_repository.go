...
type ElasticJWKRepository interface {
	...
	Create(ctx context.Context, elasticJWK *cryptoutilAppsSmKmsModel.ElasticJWK) error

	// Get retrieves an Elastic JWK by KID within a tenant.
	Get(ctx context.Context, tenantID googleUuid.UUID, kid string) (*cryptoutilAppsSmKmsModel.ElasticJWK, error)

	// GetByID retrieves an Elastic JWK by its UUID.
	GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsSmKmsModel.ElasticJWK, error)

	// List retrieves all Elastic JWKs for a tenant with pagination.
	List(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.ElasticJWK, int64, error)

	// Update updates an existing Elastic JWK.
	Update(ctx context.Context, elasticJWK *cryptoutilAppsSmKmsModel.ElasticJWK) error
...
// Create stores a new Elastic JWK.
func (r *gormElasticJWKRepository) Create(ctx context.Context, elasticJWK *cryptoutilAppsSmKmsModel.ElasticJWK) error {
...
func (r *gormElasticJWKRepository) Get(ctx context.Context, tenantID googleUuid.UUID, kid string) (*cryptoutilAppsSmKmsModel.ElasticJWK, error) {
	var elasticJWK cryptoutilAppsSmKmsModel.ElasticJWK
...
// GetByID retrieves an Elastic JWK by its UUID.
func (r *gormElasticJWKRepository) GetByID(ctx context.Context, id googleUuid.UUID) (*cryptoutilAppsSmKmsModel.ElasticJWK, error) {
	var elasticJWK cryptoutilAppsSmKmsModel.ElasticJWK
	if err := r.db.WithContext(ctx).
		Where("id = ?", id.String()).
		First(&elasticJWK).Error; err != nil {
...
// List retrieves all Elastic JWKs for a tenant with pagination.
// CRITICAL: Filters by tenant_id ONLY - realms are authn-only, NOT data scope.
func (r *gormElasticJWKRepository) List(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.ElasticJWK, int64, error) {
	var (
		elasticJWKs []*cryptoutilAppsSmKmsModel.ElasticJWK
		total       int64
	)
	...
	if err := r.db.WithContext(ctx).
		Model(&cryptoutilAppsSmKmsModel.ElasticJWK{}).
...
// Update updates an existing Elastic JWK.
func (r *gormElasticJWKRepository) Update(ctx context.Context, elasticJWK *cryptoutilAppsSmKmsModel.ElasticJWK) error {
...
func (r *gormElasticJWKRepository) Delete(ctx context.Context, id googleUuid.UUID) error {
	if err := r.db.WithContext(ctx).
		Where("id = ?", id.String()).
		Delete(&cryptoutilAppsSmKmsModel.ElasticJWK{}).Error; err != nil {
