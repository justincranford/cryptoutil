...
func TestMessageRecipientJWK_TableName(t *testing.T) {
	...
	mrj := cryptoutilAppsSmKmsModel.MessageRecipientJWK{}
...
func TestMessageRecipientJWK_FieldTypes(t *testing.T) {
	...
	mrj := cryptoutilAppsSmKmsModel.MessageRecipientJWK{
		...
		CreatedAt:    createdAt,
		Message: cryptoutilAppsSmKmsModel.Message{
			ID:       messageID,
...
func TestMessageRecipientJWK_ZeroValue(t *testing.T) {
	...
	var mrj cryptoutilAppsSmKmsModel.MessageRecipientJWK
...
func TestMessageRecipientJWK_MultiRecipientScenario(t *testing.T) {
	...
	jwks := make([]cryptoutilAppsSmKmsModel.MessageRecipientJWK, len(recipients))
	for i, recipID := range recipients {
		jwks[i] = cryptoutilAppsSmKmsModel.MessageRecipientJWK{
			ID:           googleUuid.New(),
			RecipientID:  recipID,
			MessageID:    messageID,
