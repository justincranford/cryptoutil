...
type ElasticJWKService interface {
	...
	CreateElasticJWK(ctx context.Context, tenantID googleUuid.UUID, algorithm, use string, maxMaterials int) (*cryptoutilAppsSmKmsModel.ElasticJWK, *cryptoutilAppsSmKmsModel.MaterialJWK, error)

	// GetElasticJWK retrieves an elastic JWK by ID.
	GetElasticJWK(ctx context.Context, tenantID, id googleUuid.UUID) (*cryptoutilAppsSmKmsModel.ElasticJWK, error)

	// ListElasticJWKs lists elastic JWKs for a tenant with pagination.
	ListElasticJWKs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.ElasticJWK, int64, error)
...
func (s *elasticJWKServiceImpl) CreateElasticJWK(ctx context.Context, tenantID googleUuid.UUID, algorithm, use string, maxMaterials int) (*cryptoutilAppsSmKmsModel.ElasticJWK, *cryptoutilAppsSmKmsModel.MaterialJWK, error) {
	...
	// Validate use.
	if use != cryptoutilAppsSmKmsModel.KeyUseSig && use != cryptoutilAppsSmKmsModel.KeyUseEnc {
	...
	elasticJWK := &cryptoutilAppsSmKmsModel.ElasticJWK{
		ID:                   elasticID,
		TenantID:             tenantID,
		KID:                  elasticKID,
		KeyType:              keyType,
...
// GetElasticJWK retrieves an elastic JWK by ID.
func (s *elasticJWKServiceImpl) GetElasticJWK(ctx context.Context, tenantID, id googleUuid.UUID) (*cryptoutilAppsSmKmsModel.ElasticJWK, error) {
...
// ListElasticJWKs lists elastic JWKs for a tenant with pagination.
func (s *elasticJWKServiceImpl) ListElasticJWKs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.ElasticJWK, int64, error) {
...
func (s *elasticJWKServiceImpl) createMaterialJWK(ctx context.Context, elasticJWK *cryptoutilAppsSmKmsModel.ElasticJWK, active bool) (*cryptoutilAppsSmKmsModel.MaterialJWK, error) {
	...
	materialJWK := &cryptoutilAppsSmKmsModel.MaterialJWK{
		ID:             materialID,
...
func mapAlgorithmToKeyType(algorithm string) string {
	...
	case cryptoutilSharedMagic.JoseAlgRS256, cryptoutilSharedMagic.JoseAlgRS384, cryptoutilSharedMagic.JoseAlgRS512,
		...
		return cryptoutilAppsSmKmsModel.KeyTypeRSA
	case cryptoutilSharedMagic.JoseAlgES256, cryptoutilSharedMagic.JoseAlgES384, cryptoutilSharedMagic.JoseAlgES512,
		...
		return cryptoutilAppsSmKmsModel.KeyTypeEC
	case cryptoutilSharedMagic.JoseAlgEdDSA, cryptoutilSharedMagic.JoseKeyTypeOKPEd25519:
		return cryptoutilAppsSmKmsModel.KeyTypeOKP
	case cryptoutilSharedMagic.JoseEncA128GCM, cryptoutilSharedMagic.JoseEncA192GCM, cryptoutilSharedMagic.JoseEncA256GCM,
		...
		return cryptoutilAppsSmKmsModel.KeyTypeOct
	default:
		return ""
	}
}
