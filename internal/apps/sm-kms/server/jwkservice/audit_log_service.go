...
// package jwkservice provides business logic services for sm-kms.
package jwkservice
...
type AuditLogService interface {
	...
	ListAuditLogs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error)

	// ListAuditLogsByElasticJWK lists audit logs for a specific elastic JWK.
	ListAuditLogsByElasticJWK(ctx context.Context, tenantID, elasticJWKID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error)

	// ListAuditLogsByOperation lists audit logs by operation type.
	ListAuditLogsByOperation(ctx context.Context, tenantID googleUuid.UUID, operation string, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error)

	// GetAuditConfig gets the audit configuration for a tenant.
	GetAuditConfig(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsSmKmsModel.AuditConfig, error)

	// UpdateAuditConfig updates the audit configuration for a tenant.
	UpdateAuditConfig(ctx context.Context, tenantID googleUuid.UUID, config *cryptoutilAppsSmKmsModel.AuditConfig) error
...
type auditLogServiceImpl struct {
	auditLogRepo    cryptoutilAppsSmKmsRepository.AuditLogRepository
	auditConfigRepo cryptoutilAppsSmKmsRepository.AuditConfigRepository
...
func (s *auditLogServiceImpl) LogOperation(ctx context.Context, tenantID googleUuid.UUID, elasticJWKID *googleUuid.UUID, operation, requestID string, success bool, errorMessage *string) error {
	...
	entry := &cryptoutilAppsSmKmsModel.AuditLogEntry{
		ID:           googleUuid.New(),
		TenantID:     tenantID,
...
// ListAuditLogs lists audit logs for a tenant with pagination.
func (s *auditLogServiceImpl) ListAuditLogs(ctx context.Context, tenantID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error) {
...
// ListAuditLogsByElasticJWK lists audit logs for a specific elastic JWK.
func (s *auditLogServiceImpl) ListAuditLogsByElasticJWK(ctx context.Context, tenantID, elasticJWKID googleUuid.UUID, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error) {
...
// ListAuditLogsByOperation lists audit logs by operation type.
func (s *auditLogServiceImpl) ListAuditLogsByOperation(ctx context.Context, tenantID googleUuid.UUID, operation string, offset, limit int) ([]*cryptoutilAppsSmKmsModel.AuditLogEntry, int64, error) {
...
// GetAuditConfig gets the audit configuration for a tenant.
func (s *auditLogServiceImpl) GetAuditConfig(ctx context.Context, tenantID googleUuid.UUID) (*cryptoutilAppsSmKmsModel.AuditConfig, error) {
	...
	return &cryptoutilAppsSmKmsModel.AuditConfig{
		TenantID:     tenantID,
		Operation:    cryptoutilAppsSmKmsModel.OperationGenerate, // Default operation.
		Enabled:      true,
...
// UpdateAuditConfig updates the audit configuration for a tenant.
func (s *auditLogServiceImpl) UpdateAuditConfig(ctx context.Context, tenantID googleUuid.UUID, config *cryptoutilAppsSmKmsModel.AuditConfig) error {
