...
func TestAdminServerLifecycle(t *testing.T) {
	...
	t.Run("StartAndShutdown", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_authz_admin_lifecycle")
...
func TestAdminServerActualPort(t *testing.T) {
	...
	t.Run("AfterStart", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_authz_admin_port_after")
		cfg.AuthZ.AdminPort = 0 // Dynamic port.
		ctx := context.Background()
...
func TestAdminEndpointLivez(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_authz_admin_livez")
	cfg.AuthZ.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
...
func TestAdminEndpointReadyz(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_authz_admin_readyz")
	cfg.AuthZ.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
...
func TestAdminEndpointShutdown(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_authz_admin_shutdown_endpoint")
	cfg.AuthZ.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
