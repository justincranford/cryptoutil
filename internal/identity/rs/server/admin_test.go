...
func TestNewAdminHTTPServer(t *testing.T) {
	...
	t.Run("ValidConfig", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin")
...
func TestAdminServerLifecycle(t *testing.T) {
	...
	t.Run("StartAndShutdown", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_lifecycle")
		cfg.RS.AdminPort = 0 // Dynamic port.
		ctx := context.Background()
	...
	t.Run("ShutdownWithoutStart", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_no_start")
		ctx := context.Background()
	...
	t.Run("ShutdownWithNilContext", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_shutdown_nil_ctx")
		ctx := context.Background()
...
func TestAdminServerActualPort(t *testing.T) {
	...
	t.Run("BeforeStart", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_port_before")
		ctx := context.Background()
	...
	t.Run("AfterStart", func(t *testing.T) {
		...
		cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_port_after")
		cfg.RS.AdminPort = 0 // Dynamic port.
		ctx := context.Background()
...
func TestAdminEndpointLivez(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_livez")
	cfg.RS.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
...
func TestAdminEndpointReadyz(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_readyz")
	cfg.RS.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
...
func TestAdminEndpointShutdown(t *testing.T) {
	...
	cfg := cryptoutilIdentityConfig.RequireNewForTest("test_rs_admin_shutdown_endpoint")
	cfg.RS.AdminPort = 0 // Dynamic port.
	ctx := context.Background()
