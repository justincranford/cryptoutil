...
See [ARCHITECTURE.md Section 12.6 Secrets Management in Deployments](../../docs/ARCHITECTURE.md#133-secrets-management-in-deployments) for Docker secrets enforcement in compose files.
