...
See [ENG-HANDBOOK.md Section 2.1.1 Agent Architecture](../../docs/ENG-HANDBOOK.md#211-agent-architecture) for dual canonical strategy.
...
See [ENG-HANDBOOK.md Section 2.1.1 Agent Architecture](../../docs/ENG-HANDBOOK.md#211-agent-architecture) for agent isolation principles and self-containment requirements.
...
See [ENG-HANDBOOK.md Section 2.4 Implementation Strategy](../../docs/ENG-HANDBOOK.md#24-implementation-strategy) for continuous execution patterns and autonomous agent requirements.
...
See [ENG-HANDBOOK.md Section 2.1.2 Agent Catalog](../../docs/ENG-HANDBOOK.md#212-agent-catalog) for planning-based agent patterns and Phase 0 research workflow.

## Agent Tool Discovery

**Four tool sources** with different discovery methods.

<!-- @source from="docs/ENG-HANDBOOK.md" as="agent-tool-discovery" -->
...
See [ENG-HANDBOOK.md Section 2.1.6 Agent Tool Discovery](../../docs/ENG-HANDBOOK.md#216-agent-tool-discovery) for the complete tool discovery methodology.
