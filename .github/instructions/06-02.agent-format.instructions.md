...
- `description` mismatch between Copilot skill and Claude skill
- `argument-hint` mismatch between Copilot skill and Claude skill (when the skill has one)
...
**Legacy commands** (`.claude/commands/NAME.md`): Still supported by Claude Code but superseded by the skills directory format (`.claude/skills/NAME/SKILL.md`). Skills take precedence when both exist. Migrate existing commands per `docs/framework-v8/carryover.md`.
