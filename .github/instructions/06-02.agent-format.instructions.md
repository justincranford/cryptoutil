...
**Four tool sources** with different discovery methods. Keep `docs/UPDATE-TOOLS.md` synchronized whenever VS Code, extensions, or MCP servers are updated.
...
See [ARCHITECTURE.md Section 2.1.6 Agent Tool Discovery](../../docs/ARCHITECTURE.md#216-agent-tool-discovery) for the complete tool discovery methodology and reference to `docs/UPDATE-TOOLS.md`.
