...
type ServiceServer interface {
    ...
    // full interface: internal/apps/template/service/server/contract.go
}
```
...
Use these packages from `internal/apps/template/service/testing/` instead of reimplementing common setup:
