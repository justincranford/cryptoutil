...
<!-- @source from="docs/ARCHITECTURE.md" as="disable-keep-alives-test-transport" -->
...
<!-- @source from="docs/ARCHITECTURE.md" as="timeout-double-multiplication-antipattern" -->
...
<!-- @source from="docs/ARCHITECTURE.md" as="sequential-test-exemption" -->
...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for file size limits and refactoring requirements.
