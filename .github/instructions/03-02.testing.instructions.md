...
See [ENG-HANDBOOK.md Section 10.4 E2E Testing Strategy](../../docs/ENG-HANDBOOK.md#104-e2e-testing-strategy) for PostgreSQL mTLS verification patterns in E2E tests.
