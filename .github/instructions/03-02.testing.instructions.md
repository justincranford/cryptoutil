...
See [ARCHITECTURE.md Section 10.2.4 Test Seam Injection Pattern](../../docs/ARCHITECTURE.md#1024-test-seam-injection-pattern) for the full decision matrix, parallel-safety rules, and FORBIDDEN patterns.
