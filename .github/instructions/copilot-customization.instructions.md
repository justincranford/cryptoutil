...
- **ALWAYS exclude internal/cicd/cicd.go and internal/cicd/cicd_test.go from directory walks** in cicd commands (go-enforce-any, go-enforce-test-patterns) to prevent the tool from modifying its own test patterns or checking itself
