...
**Reference**: See `.specify/memory/auth-factors.md` for authoritative authentication factor list (single source of truth)
...
**Quick Reference** (Complete details in `.specify/memory/auth-factors.md`):
