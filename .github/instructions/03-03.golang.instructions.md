...
See [ARCHITECTURE.md Section 4.3 Component Architecture](../../docs/ARCHITECTURE.md#43-component-architecture) and [Section 5.1 Service Framework Pattern](../../docs/ARCHITECTURE.md#51-service-framework-pattern) for layered architecture and design patterns.
