...
**Reference**: See `.specify/memory/cross-platform.md` for complete specifications (autoapprove wrapper, HTTP commands by environment, script language preference, authorized chat commands, Docker pre-pull, PowerShell notes)
...
| Docker healthchecks | `wget` | `wget --no-check-certificate -q -O /dev/null https://127.0.0.1:9090/admin/v1/livez` |
