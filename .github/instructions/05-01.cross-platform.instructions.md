...
**Docker Desktop Upgrade Warning**: After ANY Docker Desktop upgrade, run the full E2E test suite. Upgrades MAY break testcontainers-go API compatibility — symptoms include socket errors and container startup failures.
...
See [ARCHITECTURE.md Section 13.7 Infrastructure Blocker Escalation](../../docs/ARCHITECTURE.md#137-infrastructure-blocker-escalation) for three-encounter escalation rule.
