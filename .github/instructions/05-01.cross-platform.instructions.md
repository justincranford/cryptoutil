...
<!-- @source from="docs/ARCHITECTURE.md" as="scripting-language-policy" -->
...
<!-- @source from="docs/ARCHITECTURE.md" as="docker-desktop-startup" -->
...
<!-- @source from="docs/ARCHITECTURE.md" as="docker-desktop-upgrade" -->
...
See [ARCHITECTURE.md Section 14.7 Infrastructure Blocker Escalation](../../docs/ARCHITECTURE.md#147-infrastructure-blocker-escalation) for three-encounter escalation rule.
