...
```bash
# Health checks
autoapprove curl https://127.0.0.1:9090/admin/api/v1/livez
...
| Docker healthchecks | `wget` | `wget --no-check-certificate -q -O /dev/null https://127.0.0.1:9090/admin/api/v1/livez` | Available in Alpine, lighter than curl |
