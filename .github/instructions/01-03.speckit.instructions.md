...
❌ **Append session analysis to DETAILED.md** (session work does not need documentation)

### ALWAYS DO

✅ **Skip documentation for session-specific work** (no new docs, no DETAILED.md entries)
...
**Session-specific work** → No documentation needed
