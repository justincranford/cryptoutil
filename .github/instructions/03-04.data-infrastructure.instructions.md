...
<!-- @source from="docs/ARCHITECTURE.md" as="sqlite-barrier-outside-tx" -->
...
See [ARCHITECTURE.md Section 5.2.4](../../docs/ARCHITECTURE.md#524-database-compatibility-rules) for the SQLite + Barrier outside transaction rule.
...
See [ARCHITECTURE.md Section 5.2.5 Framework Shared Types](../../docs/ARCHITECTURE.md#525-framework-shared-types) for type details, usage patterns, and alias strategy.
...
See [ARCHITECTURE.md Section 13.2 Config File Architecture](../../docs/ARCHITECTURE.md#132-config-file-architecture) for directory structure and file type details.

See [ARCHITECTURE.md Section 9.2 Configuration Architecture & Strategy](../../docs/ARCHITECTURE.md#92-configuration-architecture--strategy) for configuration management patterns and priority order.
