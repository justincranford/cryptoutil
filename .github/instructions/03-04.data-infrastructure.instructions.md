...
See [ARCHITECTURE.md Section 7. Data Architecture](../../docs/ARCHITECTURE.md#L1378) for database strategy, multi-tenancy patterns, connection pooling, and migration management.

See [ARCHITECTURE.md Section 5.2 Service Builder Pattern](../../docs/ARCHITECTURE.md#L960) for builder usage, ServiceResources, and registration flow patterns.
