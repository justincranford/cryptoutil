...
See [ENG-HANDBOOK.md Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for cross-database compatibility patterns and GORM strategies.
...
See [ENG-HANDBOOK.md Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for comprehensive GORM patterns and database configuration.
...
See [ENG-HANDBOOK.md Section 5.2.4](../../docs/ENG-HANDBOOK.md#524-database-compatibility-rules) for the SQLite + Barrier outside transaction rule.

See [ENG-HANDBOOK.md Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) and [Section 10.3 Integration Testing Strategy](../../docs/ENG-HANDBOOK.md#103-integration-testing-strategy) for SQLite configuration and testing patterns.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) and [Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for multi-tenancy patterns and schema isolation strategies.
...
See [ENG-HANDBOOK.md Section 5.2 Service Builder Pattern](../../docs/ENG-HANDBOOK.md#52-service-builder-pattern) and [Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for migration management and versioning patterns.
...
See [ENG-HANDBOOK.md Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for connection pooling configuration and best practices.

## Error Mapping

**Pattern**: toAppErr method maps GORM errors to HTTP errors (ErrRecordNotFound -> 404, ErrDuplicatedKey -> 409).

See [ENG-HANDBOOK.md Section 8. API Architecture](../../docs/ENG-HANDBOOK.md#8-api-architecture) for error mapping and HTTP status code patterns.
...
See [ENG-HANDBOOK.md Section 5.2.5 Framework Shared Types](../../docs/ENG-HANDBOOK.md#525-framework-shared-types) for type details, usage patterns, and alias strategy.
...
See [ENG-HANDBOOK.md Section 5.2 Service Builder Pattern](../../docs/ENG-HANDBOOK.md#52-service-builder-pattern) for builder usage, ServiceResources, and registration flow patterns.
...
See [ENG-HANDBOOK.md Section 9.2 Configuration Architecture & Strategy](../../docs/ENG-HANDBOOK.md#92-configuration-architecture--strategy) for configuration management patterns and priority order.

## Cross-References

See [ENG-HANDBOOK.md Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for database strategy, multi-tenancy patterns, connection pooling, and migration management.
