...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for continuous execution patterns.
...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for blocker handling and work discovery strategies.
...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for work discovery and task management patterns.
...
See [ARCHITECTURE.md Section 14.7 Infrastructure Blocker Escalation](../../docs/ARCHITECTURE.md#147-infrastructure-blocker-escalation) for the three-encounter escalation rule and infrastructure categories.
...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for implementation guidelines and code quality standards.
