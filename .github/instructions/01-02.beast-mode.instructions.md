...
- ✅ **Thoroughness**: Evidence-based validation at every step (see [06-01.evidence-based.instructions.md](.github/instructions/06-01.evidence-based.instructions.md))
- ✅ **Reliability**: Quality gates enforced (see [03-02.testing.instructions.md](.github/instructions/03-02.testing.instructions.md) for coverage/mutation targets)
...
- Task complete → Commit (see [05-02.git.instructions.md](.github/instructions/05-02.git.instructions.md)) → IMMEDIATELY start next task (zero pause, zero text to user)

---

**Priorities** (NO EXCEPTIONS):
- ✅ Correctness, completeness, thoroughness (see [06-01.evidence-based.instructions.md](.github/instructions/06-01.evidence-based.instructions.md))
- ✅ Quality gates enforced (see [03-02.testing.instructions.md](.github/instructions/03-02.testing.instructions.md))
...
**Execution Pattern**: Task complete → [Commit](.github/instructions/05-02.git.instructions.md) → Next task (zero pause, zero text)
...
- [03-02.testing.instructions.md](.github/instructions/03-02.testing.instructions.md) - Testing standards, quality gates
- [05-02.git.instructions.md](.github/instructions/05-02.git.instructions.md) - Git commit conventions
ork Discovery (No Active Tasks)
...
- Root cause analysis: Use `get_errors`, debug thoroughly, add logging/tests as needed Quality Gates (Per Task)
...
See: [06-01.evidence-based](.github/instructions/06-01.evidence-based.instructions.md), [03-02.testing](.github/instructions/03-02.testing.instructions.md), [05-02.git](.github/instructions/05-02.git.instructions.md)
