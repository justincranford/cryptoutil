...
- Always use crypto/rand, never math/rand (see `02-07.cryptography.instructions.md`)
- Full cert chain validation, MinVersion: TLS 1.3+ (see `02-09.pki.instructions.md`)
