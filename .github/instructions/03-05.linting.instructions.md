...
See [ENG-HANDBOOK.md Section 11.3.3 Code Quality Enforcement](../../docs/ENG-HANDBOOK.md#1133-code-quality-enforcement), [Section 2.5 Quality Strategy](../../docs/ENG-HANDBOOK.md#25-quality-strategy), and [Section 9.9 Pre-Commit Hook Architecture](../../docs/ENG-HANDBOOK.md#99-pre-commit-hook-architecture) for comprehensive quality enforcement patterns.
...
See [ENG-HANDBOOK.md Section 11.3.1 Linter Configuration Architecture](../../docs/ENG-HANDBOOK.md#1131-linter-configuration-architecture) and [Section 2.5 Quality Strategy](../../docs/ENG-HANDBOOK.md#25-quality-strategy) for golangci-lint v2 configuration and version-specific syntax.
...
See [ENG-HANDBOOK.md Section 11.3.3 Code Quality Enforcement](../../docs/ENG-HANDBOOK.md#1133-code-quality-enforcement) and [Section 2.5 Quality Strategy](../../docs/ENG-HANDBOOK.md#25-quality-strategy) for critical linter rules and enforcement patterns.
...
See [ENG-HANDBOOK.md Section 11.3.1 Linter Configuration Architecture](../../docs/ENG-HANDBOOK.md#1131-linter-configuration-architecture) for complete linter categorization and auto-fix workflows.
...
See [ENG-HANDBOOK.md Section 11.2 Quality Gates](../../docs/ENG-HANDBOOK.md#112-quality-gates) and [Section 9.9 Pre-Commit Hook Architecture](../../docs/ENG-HANDBOOK.md#99-pre-commit-hook-architecture) for linting workflow patterns and quality gate enforcement.

## Secret Detection

Use `gosec` (part of golangci-lint): G401 (weak crypto), G501 (import blocklist), G505 (weak random).

See [ENG-HANDBOOK.md Section 6.2 SDLC Security Strategy](../../docs/ENG-HANDBOOK.md#62-sdlc-security-strategy) for secret detection and security gate enforcement.

## Batch Lint Fixing

Use `multi_replace_string_in_file` for efficiency (up to 10 similar fixes per batch).

See [ENG-HANDBOOK.md Section 11.3.3 Code Quality Enforcement](../../docs/ENG-HANDBOOK.md#1133-code-quality-enforcement) for batch fixing patterns and automation.
...
See [ENG-HANDBOOK.md Section 9.9.3 UTF-8 Without BOM Enforcement](../../docs/ENG-HANDBOOK.md#993-utf-8-without-bom-enforcement) for pre-commit hook details and PowerShell patterns.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) and [Section 9.7 CI/CD Workflow Architecture](../../docs/ENG-HANDBOOK.md#97-cicd-workflow-architecture) for version pinning requirements and CI/CD version consistency.
