...
See [ARCHITECTURE.md Section 15.1 Monitoring & Alerting](../../docs/ARCHITECTURE.md#151-monitoring--alerting) for Prometheus metrics, Grafana dashboards, and alerting rules.

See [ARCHITECTURE.md Section 15.3 Performance Management](../../docs/ARCHITECTURE.md#153-performance-management) for benchmarking, profiling, and optimization strategies.
