...
See [ENG-HANDBOOK.md Section 9.4.2 Docker Desktop and Testcontainers API Compatibility](../../docs/ENG-HANDBOOK.md#945-docker-desktop-and-testcontainers-api-compatibility) for diagnosis checklist and resolution guidance.
