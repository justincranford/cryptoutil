...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for telemetry flow and OpenTelemetry configuration.
...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for observability configuration patterns.
...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for structured logging patterns and trace correlation.
...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for log level definitions and usage patterns.
...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for Prometheus metrics naming and exposition.
...
See [ARCHITECTURE.md Section 9.5 Telemetry Architecture](../../docs/ARCHITECTURE.md#95-telemetry-architecture) for sampling strategies and trace configuration.
