...
See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for telemetry flow and OpenTelemetry configuration.
...
See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for observability configuration patterns.
...
See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for structured logging patterns and trace correlation.
...
See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for log level definitions and usage patterns.
...
See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for Prometheus metrics naming and exposition.
...
See [ENG-HANDBOOK.md Section 6.3 Product Security Strategy](../../docs/ENG-HANDBOOK.md#63-product-security-strategy) for sensitive data handling and audit logging requirements.

## Sampling Strategy

Configurable (default: probabilistic 10% sampling rate). Pattern: `sampling_rate: 0.1`

See [ENG-HANDBOOK.md Section 9.4 Telemetry Strategy](../../docs/ENG-HANDBOOK.md#94-telemetry-strategy) for sampling strategies and trace configuration.
...
See [ENG-HANDBOOK.md Section 9.4.1 OTel Collector Processor Constraints](../../docs/ENG-HANDBOOK.md#941-otel-collector-processor-constraints) for processor requirements and anti-patterns.
...
See [ENG-HANDBOOK.md Section 9.4.2 Docker Desktop and Testcontainers API Compatibility](../../docs/ENG-HANDBOOK.md#942-docker-desktop-and-testcontainers-api-compatibility) for diagnosis checklist and resolution guidance.

## Operational Excellence Cross-References

See [ENG-HANDBOOK.md Section 15.1 Monitoring & Alerting](../../docs/ENG-HANDBOOK.md#151-monitoring--alerting) for Prometheus metrics, Grafana dashboards, and alerting rules.

See [ENG-HANDBOOK.md Section 15.3 Performance Management](../../docs/ENG-HANDBOOK.md#153-performance-management) for benchmarking, profiling, and optimization strategies.
