...
<!-- @source from="docs/ARCHITECTURE.md" as="otel-collector-constraints" -->
...
See [ARCHITECTURE.md Section 14.1 Monitoring & Alerting](../../docs/ARCHITECTURE.md#141-monitoring--alerting) for Prometheus metrics, Grafana dashboards, and alerting rules.

See [ARCHITECTURE.md Section 14.3 Performance Management](../../docs/ARCHITECTURE.md#143-performance-management) for benchmarking, profiling, and optimization strategies.
