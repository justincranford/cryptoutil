...
See [ARCHITECTURE.md Section 13.3 Secrets Management in Deployments](../../docs/ARCHITECTURE.md#133-secrets-management-in-deployments) for secret value patterns and validation.
...
See [ARCHITECTURE.md Section 13.1.11](../../docs/ARCHITECTURE.md#13111-validation-pipeline-architecture) for pipeline diagram and detailed rules.

See [ARCHITECTURE.md Section 13.3](../../docs/ARCHITECTURE.md#133-secrets-management-in-deployments) for deployment secrets management.
