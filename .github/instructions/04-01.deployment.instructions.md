...
All 10 PS-ID deployment artifacts MUST match canonical templates after `__KEY__` placeholder substitution. Template drift is detected by `lint-fitness` template_drift and config_rules linters.
