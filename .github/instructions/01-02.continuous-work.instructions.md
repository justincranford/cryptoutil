---
description: "LLM Agent continuous work directive for Speckit sessions"
applyTo: "**"
---
# LLM Agent Continuous Work Directive - ABSOLUTE ENFORCEMENT

**Reference**: See `.specify/memory/continuous-work.md` for complete specifications (continuous work enforcement, time/token management, prohibited stop behaviors, execution rules, blocker handling, work discovery sequence)
...
- ✅ CORRECT: `read_file DETAILED.md` → find Phase 4/5/6 tasks → immediately start first task
