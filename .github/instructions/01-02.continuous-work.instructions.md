...
## Continuous Execution Guidelines from Beast-Mode-Custom Agent
...
### Acceptable Output During Execution
...
- Updates to tracking documents (`<work-dir>/plan.md` and `<work-dir>/tasks.md`) when new work discovered

**NEVER produce**:

- Status summaries between tasks
- "What's next?" questions
- Progress celebrations
- Completion announcements before ALL tasks done
