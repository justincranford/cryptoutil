...
See [ARCHITECTURE.md Section 14.1.1 Opportunistic Quality Fixes](../../docs/ARCHITECTURE.md#1411-opportunistic-quality-fixes--mandatory) for full rationale and anti-patterns.
...
See [ARCHITECTURE.md Section 11.2.6 File Size Limits](../../docs/ARCHITECTURE.md#1126-file-size-limits) and [Section 14.1 Coding Standards](../../docs/ARCHITECTURE.md#141-coding-standards) for file size enforcement and rationale.
...
See [ARCHITECTURE.md Section 11.1.4 Magic Values Organization](../../docs/ARCHITECTURE.md#1114-magic-values-organization), [Section 11.2.7 Conditional Statement Patterns](../../docs/ARCHITECTURE.md#1127-conditional-statement-patterns), and [Section 14.1 Coding Standards](../../docs/ARCHITECTURE.md#141-coding-standards) for comprehensive code pattern requirements.
...
See [ARCHITECTURE.md Section 13.5 Validator Error Aggregation Pattern](../../docs/ARCHITECTURE.md#135-validator-error-aggregation-pattern) for execution model and rationale.
