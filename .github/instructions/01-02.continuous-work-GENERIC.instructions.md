---
description: "LLM Agent continuous work directive - NEVER STOP until user clicks stop (GENERIC VERSION)"
applyTo: "**"
---
...
**Pattern**: Work → Commit → Next tool invocation (ZERO text between tasks, ZERO questions)
...
<invoke name="read_file">
  <parameter name="filePath">relevant_code_file</parameter>
</invoke>
...
**Related Documentation**: Project-specific testing standards, quality gates, evidence-based completion patterns
