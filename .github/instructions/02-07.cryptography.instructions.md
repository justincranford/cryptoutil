...
**Reference**: See `.specify/memory/cryptography.md` for complete FIPS specifications (approved/banned algorithms, library requirements)
...
2. **Password hashing: PBKDF2-HMAC-SHA256** - See `02-08.hashes.instructions.md`
...
6. **Certificate validation** - See `02-09.pki.instructions.md`
