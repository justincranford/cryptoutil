...
See [ENG-HANDBOOK.md Section 3 Product Suite Architecture](../../docs/ENG-HANDBOOK.md#3-product-suite-architecture) and [Section 4 System Architecture](../../docs/ENG-HANDBOOK.md#4-system-architecture) for comprehensive product suite and system architecture.
...
See [ENG-HANDBOOK.md Section 3.4 Port Assignments & Networking](../../docs/ENG-HANDBOOK.md#34-port-assignments--networking) for complete service and port catalog.
...
See [ENG-HANDBOOK.md Section 3.4.1 Port Design Principles](../../docs/ENG-HANDBOOK.md#341-port-design-principles) and [Section 5.3 Dual HTTPS Endpoint Pattern](../../docs/ENG-HANDBOOK.md#53-dual-https-endpoint-pattern) for port and binding standards.
...
See [ENG-HANDBOOK.md Section 5.1 Service Framework Pattern](../../docs/ENG-HANDBOOK.md#51-service-framework-pattern) for framework components and benefits.
...
See [ENG-HANDBOOK.md Section 5.3 Dual HTTPS Endpoint Pattern](../../docs/ENG-HANDBOOK.md#53-dual-https-endpoint-pattern) for comprehensive dual HTTPS endpoint documentation.
...
See [ENG-HANDBOOK.md Section 5.4 Dual API Path Pattern](../../docs/ENG-HANDBOOK.md#54-dual-api-path-pattern) for dual path design and middleware requirements.
...
See [ENG-HANDBOOK.md Section 5.5 Health Check Patterns](../../docs/ENG-HANDBOOK.md#55-health-check-patterns) for health check endpoint specifications and admin mTLS verification pattern.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) for federation and service discovery patterns.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) and [Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for multi-tenancy patterns and data isolation.
...
See [ENG-HANDBOOK.md Section 6. Security Architecture](../../docs/ENG-HANDBOOK.md#6-security-architecture) for TLS certificate configuration and generation patterns.
...
See [ENG-HANDBOOK.md Section 5.2 Service Builder Pattern](../../docs/ENG-HANDBOOK.md#52-service-builder-pattern) and [Section 7. Data Architecture](../../docs/ENG-HANDBOOK.md#7-data-architecture) for migration versioning and merged migrations.
...
See [ENG-HANDBOOK.md Section 6.4 Cryptographic Architecture](../../docs/ENG-HANDBOOK.md#64-cryptographic-architecture) and [Section 6.7 Key Management System Architecture](../../docs/ENG-HANDBOOK.md#67-key-management-system-architecture) for key rotation strategies and elastic key ring patterns.
...
See [ENG-HANDBOOK.md Section 13.2 Config File Architecture](../../docs/ENG-HANDBOOK.md#132-config-file-architecture) for directory structure and file type details.
...
See [ENG-HANDBOOK.md Section 9.11.3 Entity Registry](../../docs/ENG-HANDBOOK.md#9113-entity-registry) for full details.
...
See [ENG-HANDBOOK.md Section 9.11.1 Fitness Sub-Linter Catalog](../../docs/ENG-HANDBOOK.md#9111-fitness-sub-linter-catalog) and `internal/apps/tools/cicd_lint/lint_fitness/banned_product_names/banned_product_names.go` for implementation.
