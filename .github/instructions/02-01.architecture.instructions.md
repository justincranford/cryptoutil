...
- **3 products, 9 services**: PKI (CA), JOSE (JA), SM (KMS, IM), Identity (Authz, IdP, RS, RP, SPA)
...
**PostgreSQL Ports**: pki-ca:54320, jose-ja:54321, sm-im:54322, sm-kms:54323, identity-authz:54324, identity-idp:54325, identity-rs:54326, identity-rp:54327, identity-spa:54328 (all container 0.0.0.0:5432)
...
<!-- @source from="docs/ARCHITECTURE.md" as="service-template-components" -->
