...
| SM | Instant Messenger (IM) | sm-im | 8700-8799 | 0.0.0.0:8080 | 127.0.0.1:9090 |
...
**PostgreSQL Ports**: pki-ca:54320, jose-ja:54321, sm-im:54322, sm-kms:54323, identity-authz:54324, identity-idp:54325, identity-rs:54326, identity-rp:54327, identity-spa:54328, skeleton-template:54329 (all container 0.0.0.0:5432)
...
<!-- @source from="docs/ARCHITECTURE.md" as="service-framework-components" -->
...
See [ARCHITECTURE.md Section 5.1 Service Framework Pattern](../../docs/ARCHITECTURE.md#51-service-framework-pattern) for framework components and benefits.
...
All products and product-services are defined in a single canonical registry: `internal/apps/cicd/lint_fitness/registry/registry.go`. All registry-driven fitness checks iterate `AllProductServices()` — never hardcode product names.
...
3. Run `go run ./cmd/cicd lint-fitness` — `entity-registry-completeness` catches gaps
4. Add required deployment artifacts (Dockerfile, compose.yml, configs, secrets)

See [ARCHITECTURE.md Section 9.11.2 Entity Registry](../../docs/ARCHITECTURE.md#9112-entity-registry) for full details.
...
See [ARCHITECTURE.md Section 9.11.1 Fitness Sub-Linter Catalog](../../docs/ARCHITECTURE.md#9111-fitness-sub-linter-catalog-43-total) and `internal/apps/cicd/lint_fitness/banned_product_names/banned_product_names.go` for implementation.
