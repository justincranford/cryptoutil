...
See [ARCHITECTURE.md Section 12.5 Config File Architecture](../../docs/ARCHITECTURE.md#132-config-file-architecture) for directory structure and file type details.
...
See [ARCHITECTURE.md Section 9.11.1 Fitness Sub-Linter Catalog](../../docs/ARCHITECTURE.md#9111-fitness-sub-linter-catalog-55-total) and `internal/apps/tools/cicd_lint/lint_fitness/banned_product_names/banned_product_names.go` for implementation.
