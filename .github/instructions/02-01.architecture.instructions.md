...
See [ARCHITECTURE.md Section 9.11.1 Fitness Sub-Linter Catalog](../../docs/ARCHITECTURE.md#9111-fitness-sub-linter-catalog-49-total) and `internal/apps/tools/cicd_lint/lint_fitness/banned_product_names/banned_product_names.go` for implementation.
