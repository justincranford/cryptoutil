---
description: "SQLite configuration with GORM"
applyTo: "**"
---
# Sqlite Gorm
...
**Cross-Database Compatibility**: See [03-04.database.instructions.md](.github/instructions/03-04.database.instructions.md) for PostgreSQL vs SQLite patterns
