...
See [ARCHITECTURE.md Section 2.2 Technology Standards](../../docs/ARCHITECTURE.md#L237) for version requirements and update policies across all technologies.

See [ARCHITECTURE.md Section 11.1 Code Quality](../../docs/ARCHITECTURE.md#L2136) for golangci-lint versioning and linter configuration.
