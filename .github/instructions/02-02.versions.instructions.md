...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) for version consistency and architectural decision-making principles.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) and [Section 9.7 CI/CD Workflow Architecture](../../docs/ENG-HANDBOOK.md#97-cicd-workflow-architecture) for consistency requirements across all environments.
...
|------|----------------|--------------|-----------|
| **Go** | 1.26.1+ | 2025-12-02 | <https://go.dev/doc/devel/release#go1.26.1> |
...
| Tool | Minimum Version | Release Date | Reference |
|------|----------------|--------------|-----------|
| **Docker** | 27+ | 2024-06-20 | <https://docs.docker.com/engine/release-notes/27/> |
| **Docker Compose** | v5+ | 2025-12-02 | <https://github.com/docker/compose/releases/tag/v5.0.0> |

See [ENG-HANDBOOK.md Section 9.7 CI/CD Workflow Architecture](../../docs/ENG-HANDBOOK.md#97-cicd-workflow-architecture) for tooling requirements in CI/CD pipelines and [Section 11.3 Code Quality Standards](../../docs/ENG-HANDBOOK.md#113-code-quality-standards) for linter and code quality tool versions.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) and [Section 14. Development Practices](../../docs/ENG-HANDBOOK.md#14-development-practices) for version update policies and development standards.
...
See [ENG-HANDBOOK.md Section 2.2 Architecture Strategy](../../docs/ENG-HANDBOOK.md#22-architecture-strategy) for architectural decision-making principles across all system components.

See [ENG-HANDBOOK.md Section 11.3 Code Quality Standards](../../docs/ENG-HANDBOOK.md#113-code-quality-standards) for golangci-lint versioning and linter configuration.
