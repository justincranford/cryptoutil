...
See [ARCHITECTURE.md Section 9.7 CI/CD Workflow Architecture](../../docs/ARCHITECTURE.md#97-cicd-workflow-architecture) for tooling requirements in CI/CD pipelines and [Section 11.1 Code Quality](../../docs/ARCHITECTURE.md#111-code-quality) for linter and code quality tool versions.
...
See [ARCHITECTURE.md Section 2.2 Architecture Strategy](../../docs/ARCHITECTURE.md#L222) for architectural decision-making principles across all system components.

See [ARCHITECTURE.md Section 11.1 Code Quality](../../docs/ARCHITECTURE.md#L2239) for golangci-lint versioning and linter configuration.
