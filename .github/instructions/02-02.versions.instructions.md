...
See [ARCHITECTURE.md Section 2.2 Architecture Strategy](../../docs/ARCHITECTURE.md#22-architecture-strategy) and [Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for version update policies and development standards.
