...
2. Update implement/DETAILED.md Section 2 (timeline)
3. Mark tasks complete in implement/DETAILED.md Section 1 (checklist)
4. Update implement/EXECUTIVE.md if major milestone
...
| Tasks | `specs/001-cryptoutil/TASKS.md` | Task breakdown with dependencies |
| Analysis | `specs/001-cryptoutil/ANALYSIS.md` | Coverage analysis |
| Clarifications | `specs/001-cryptoutil/CLARIFICATIONS.md` | Ambiguity resolution |
| Implementation | `specs/001-cryptoutil/implement/DETAILED.md` | Task checklist + timeline |
| Executive Summary | `specs/001-cryptoutil/implement/EXECUTIVE.md` | Stakeholder overview |
