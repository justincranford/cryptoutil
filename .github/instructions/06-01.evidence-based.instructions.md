...
See [ARCHITECTURE.md Section 14. Development Practices](../../docs/ARCHITECTURE.md#14-development-practices) for post-mortem patterns and continuous improvement workflow.
...
See [ARCHITECTURE.md Section 15.2 Incident Management](../../docs/ARCHITECTURE.md#152-incident-management) for post-mortem templates, severity levels, and response time targets.
