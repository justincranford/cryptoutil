...
See [ENG-HANDBOOK.md Section 2.4 Implementation Strategy](../../docs/ENG-HANDBOOK.md#24-implementation-strategy) and [Section 11.2 Quality Gates](../../docs/ENG-HANDBOOK.md#112-quality-gates) for evidence-based completion requirements and quality gate enforcement.
...
See [ENG-HANDBOOK.md Section 11.2.1 MANDATORY Pre-Commit Quality Gates](../../docs/ENG-HANDBOOK.md#1121-mandatory-pre-commit-quality-gates) for mandatory evidence requirements before marking work complete.
...
See [ENG-HANDBOOK.md Section 11.2 Quality Gates](../../docs/ENG-HANDBOOK.md#112-quality-gates) and [Section 2.4 Implementation Strategy](../../docs/ENG-HANDBOOK.md#24-implementation-strategy) for progressive validation workflow and completion verification checklist.

## Post-Mortem Enforcement

Every gap -> Immediate fix OR new task doc (`##.##-GAP_NAME.md`)

See [ENG-HANDBOOK.md Section 14. Development Practices](../../docs/ENG-HANDBOOK.md#14-development-practices) for post-mortem patterns and continuous improvement workflow.
...
See [ENG-HANDBOOK.md Section 11.2 Quality Gates](../../docs/ENG-HANDBOOK.md#112-quality-gates) and [Section 2.5 Quality Strategy](../../docs/ENG-HANDBOOK.md#25-quality-strategy) for quality gate violations and enforcement patterns.

## Operational Excellence Cross-References

See [ENG-HANDBOOK.md Section 15.2 Incident Management](../../docs/ENG-HANDBOOK.md#152-incident-management) for post-mortem templates, severity levels, and response time targets.
