...
Read [ARCHITECTURE.md Section 12.7 Documentation Propagation Strategy](../../../docs/ARCHITECTURE.md#134-documentation-propagation-strategy) for @source/@propagate system — include correct `@source` markers for any ARCHITECTURE.md content copied into the instruction file.
