...
- `/copilot-customization` when you need to create, update, or delete a repo-local agent, instruction, or skill
...
Use `/copilot-customization` to create, update, or delete repo-local agents, instructions, and skills.
