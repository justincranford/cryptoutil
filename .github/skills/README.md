...
- `/copilot-customization` when you need a new repo-local agent, instruction, or skill
...
| `copilot-customization` | tooling | Create a new repo-local agent, instruction, or skill and any required Claude counterpart, including Copilot agent tool allowlist maintenance | [SKILL.md](copilot-customization/SKILL.md) |
...
Use `/copilot-customization` to create new repo-local agents, instructions, and skills.
