...
| `/customization-scaffold` | Creating a new repo-local agent, instruction, or skill, including required Claude counterparts and Copilot agent tool allowlist maintenance |
