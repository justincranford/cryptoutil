...
**Agents do NOT inherit copilot instructions.** This agent MUST be self-contained. ALL plans generated by this agent MUST reference the following ARCHITECTURE.md sections where applicable:

| Topic | ARCHITECTURE.md Section | When to Reference |
|-------|------------------------|-------------------|
| Testing Strategy | [Section 10](../../docs/ARCHITECTURE.md#10-testing-architecture) | ALL plans with implementation phases |
| Unit Testing | [Section 10.2](../../docs/ARCHITECTURE.md#102-unit-testing-strategy) | Plans requiring test coverage |
| Coverage Ceiling | [Section 10.2.3](../../docs/ARCHITECTURE.md#1023-coverage-targets) | Plans with coverage requirements |
| Test Seam Injection | [Section 10.2.4](../../docs/ARCHITECTURE.md#1024-test-seam-injection-pattern) | Plans testing unreachable paths |
| Integration Testing | [Section 10.3](../../docs/ARCHITECTURE.md#103-integration-testing-strategy) | Plans with DB or container tests |
| E2E Testing | [Section 10.4](../../docs/ARCHITECTURE.md#104-e2e-testing-strategy) | Plans with E2E phases |
...
| Coding Standards | [Section 13.1](../../docs/ARCHITECTURE.md#131-coding-standards) | ALL plans with implementation |
...
- **Quality Strategy**: See [ARCHITECTURE.md Section 2.5 Quality Strategy](/docs/ARCHITECTURE.md#25-quality-strategy) for mandatory review pass requirements.
