...
func GenerateRSAKeyPair(rsaBits int) func() (Key, error) {
...
func GenerateECDSAKeyPair(ecdsaCurve elliptic.Curve) func() (Key, error) {
	return func() (Key, error) {
...
func GenerateECDHKeyPair(ecdhCurve ecdh.Curve) func() (Key, error) {
	return func() (Key, error) {
...
func GenerateEDKeyPair(edCurve string) func() (Key, error) {
	return func() (Key, error) {
		switch edCurve {
		case "Ed448":
...
func GenerateAESKey(aesBits int) func() (Key, error) {
	return func() (Key, error) {
...
func GenerateHMACKey(hmacBits int) func() (Key, error) {
	return func() (Key, error) {
		if hmacBits < 256 {
