...
### Core Development (Go 1.26.1+)

**Why this version?** Go 1.26.1 is required for:
...
**Project dependencies requiring Go 1.26.1+:**
...
# Verify installation
go version
# Expected: go version go1.26.1 windows/amd64
```
