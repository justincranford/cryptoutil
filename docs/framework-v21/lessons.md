# Lessons - Framework V21: Server Subdirectory Migration and Tooling Debt Closure

**Created**: 2026-04-30
**Purpose**: Phase post-mortem lessons for Framework V21. Populate after each phase passes its quality gates.
