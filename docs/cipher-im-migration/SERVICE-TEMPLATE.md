# Cipher-IM Service Template Migration - Active Tasks
...
MUST: Create evidence of completion per phase and task in docs/cipher-im-migration/evidence/; prefixed with phase number and task number
MUST: Write post-mortem analysis for each completed phase in docs/cipher-im-migration/post-mortems/
...
### ✅ P0.3: Refactor internal/cipher/server/ Files

- [x] P0.3.1: Move repository code from internal/cipher/server/ to internal/cipher/server/repository/ (N/A - already organized)
- [x] P0.3.2: Move authentication/authorization code from internal/cipher/server/ to internal/cipher/server/realms/ (N/A - authn.go already in realms/)
- [x] P0.3.3: Move auth-related middleware from internal/cipher/server/ to internal/cipher/server/realms/ (middleware.go moved)
- [x] P0.3.4: Move realm validation code from internal/cipher/server/ to internal/cipher/server/realms/ (N/A - tests only, kept in server root)
- [x] P0.3.5: Move API handler code from internal/cipher/server/ to internal/cipher/server/apis/ (N/A - already organized)
- [x] P0.3.6: Move business logic code from internal/cipher/server/ to internal/cipher/server/businesslogic/ (N/A - directory exists)
- [x] P0.3.7: Move utility functions from internal/cipher/server/ to internal/cipher/server/util/ (N/A - already organized)
- [x] P0.3.8: Leave server.go and listener-related code in internal/cipher/server/ package (Done - not moved)
...
- [x] P4.0.3: Verify zero context.TODO() in internal/cipher
...
- Evidence: `docs/cipher-im-migration/evidence/P6-quality-gates-complete.md`
...
- Evidence: `docs/cipher-im-migration/evidence/P7.1-remove-obsolete-tables-complete.md`
...
- Evidence: `docs/cipher-im-migration/evidence/P8.0-cgo-consolidation-complete.md`
...
#### 3. internal/cipher/server (TIMEOUT)
...
5. **P0.3**: Refactor internal/cipher/server/ Files
...
1. ✅ **internal/cipher/crypto should NOT be removed** - Package needed for password hashing, must use shared/hash
...
5. **P0.3: Refactor internal/cipher/server/ Files**
   - Move repository code from internal/cipher/server/ to internal/cipher/server/repository/
   - Move authentication/authorization code from internal/cipher/server/ to internal/cipher/server/realms/
   - Move auth-related middleware from internal/cipher/server/ to internal/cipher/server/realms/
   - Move realm validation code from internal/cipher/server/ to internal/cipher/server/realms/
   - Move API handler code from internal/cipher/server/ to internal/cipher/server/apis/
   - Move business logic code from internal/cipher/server/ to internal/cipher/server/businesslogic/
   - Move utility functions from internal/cipher/server/ to internal/cipher/server/util/
   - Leave server.go and listener-related code in internal/cipher/server/ package
   - Update all imports across the codebase
   - Run all tests recursively under internal\cipher to ensure no breakage
