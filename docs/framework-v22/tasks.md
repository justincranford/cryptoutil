...
- **Acceptance Criteria**:
  ...
  - [x] Evidence archived in `test-output/v22-phase1/`.
...
- **Acceptance Criteria**:
  ...
  - [x] Evidence archived in `test-output/v22-phase2/`.
...
- **Acceptance Criteria**:
  ...
  - [x] Evidence archived in `test-output/v22-phase3/`.
...
- **Acceptance Criteria**:
  ...
  - [x] Evidence archived in `test-output/v22-phase4/`.
...
- **Status**: ❌
- **Acceptance Criteria**:
  - [x] Final inventory of changed surfaces archived under `test-output/v22-phase5/`.
  - [x] `docs/framework-v22/plan.md`, `docs/framework-v22/tasks.md`, and repository state are consistent.
...
- **Status**: ❌
- **Acceptance Criteria**:
  - [x] `docs/framework-v22/lessons.md` reviewed after all execution phases complete.
...
- **Acceptance Criteria**:
  ...
  - [x] Evidence archived in `test-output/v22-phase6/`.
