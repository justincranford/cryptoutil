...
| `cryptoutil/internal/kms/server/repository/orm` | `cryptoutilKmsOrmRepository` | `cryptoutilOrmRepository` |
| `cryptoutil/internal/kms/server/repository/sqlrepository` | `cryptoutilKmsSQLRepository` | `cryptoutilSQLRepository` |
