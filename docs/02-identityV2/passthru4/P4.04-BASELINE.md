...
- **authz**: 24.3% ❌ (target: 85%, gap: -60.7%)
- **authz/clientauth**: 35.9% ❌ (target: 85%, gap: -49.1%)
- **idp**: 53.5% ❌ (target: 85%, gap: -31.5%)
- **idp/auth**: 0.0% ❌ (target: 85%, gap: -85.0%)
- **issuer**: 58.7% ❌ (target: 85%, gap: -26.3%)
