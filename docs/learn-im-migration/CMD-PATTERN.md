...
- `cryptoutil learn im server --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im server` → `internal/cmd/learn/learn.go` → `im(args)` → `server(args)`

- `cryptoutil learn im client --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im client` → `internal/cmd/learn/learn.go` → `im(args)` → `client(args)`

- `cryptoutil learn im init --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im init` → `internal/cmd/learn/learn.go` → `im(args)` → `init(args)`

- `cryptoutil learn im health --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im health` → `internal/cmd/learn/learn.go` → `im(args)` → `health(args)`

- `cryptoutil learn im livez --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im livez` → `internal/cmd/learn/learn.go` → `im(args)` → `livez(args)`

- `cryptoutil learn im readyz --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn im readyz` → `internal/cmd/learn/learn.go` → `im(args)` → `readyz(args)`

- `cryptoutil learn shutdown stop --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `cryptoutil learn shutdown stop` → `internal/cmd/learn/learn.go` → `im(args)` → `shutdown(args)`
...
- `learn im server --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `learn im server` → `internal/cmd/learn/learn.go` → `im(args)` → `server(args)`

- `learn im client --config configs/cryptoutil/config.yml --config configs/learn/config.yml --config configs/learn/im/config.yml`
  → `learn im client` → `internal/cmd/learn/learn.go` → `im(args)` → `client(args)`
...
- `cryptoutil-compose jose up` - Start all services for learn product
- `cryptoutil-compose jose-ja up` - Start learn-im service only
- `cryptoutil-compose pki up` - Start all services for learn product
- `cryptoutil-compose pki-ca up` - Start learn-im service only
- `cryptoutil-compose sm up` - Start all services for learn product
- `cryptoutil-compose sm-kms up` - Start learn-im service only
- `cryptoutil-compose learn up` - Start all services for learn product
...
- `cryptoutil-demo jose up` - Start all services for learn product, with demo configs
- `cryptoutil-demo jose-ja up` - Start learn-im service only, with demo configs
- `cryptoutil-demo pki up` - Start all services for learn product, with demo configs
- `cryptoutil-demo pki-ca up` - Start learn-im service only, with demo configs
- `cryptoutil-demo sm up` - Start all services for learn product, with demo configs
- `cryptoutil-demo sm-kms up` - Start learn-im service only, with demo configs
- `cryptoutil-demo learn up` - Start all services for learn product, with demo configs
- `cryptoutil-demo learn-im up` - Start learn-im service only, with demo configs
...
- `cryptoutil-e2e jose up` - Start all services for learn product, with e2e configs
- `cryptoutil-e2e jose-ja up` - Start learn-im service only, with e2e configs
- `cryptoutil-e2e pki up` - Start all services for learn product, with e2e configs
- `cryptoutil-e2e pki-ca up` - Start learn-im service only, with e2e configs
- `cryptoutil-e2e sm up` - Start all services for learn product, with e2e configs
- `cryptoutil-e2e sm-kms up` - Start learn-im service only, with e2e configs
- `cryptoutil-e2e learn up` - Start all services for learn product, with e2e configs
- `cryptoutil-e2e learn-im up` - Start learn-im service only, with e2e configs
