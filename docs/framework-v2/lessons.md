...
4. **Auth contracts**: AuthN/AuthZ are 100% owned by service-template. Auth contract tests (401/403 rejection) belong in `RunContractTests` in service-template, NOT in service-specific tests. Product-services only pass config objects.
