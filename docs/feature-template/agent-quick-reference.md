...
**NO ASKING, NO PLANNING, JUST START**
...
**Summary format** (ONLY at session end):
```
Completed: Tasks X, Y, Z (descriptions)
In Progress: Task N (current state)
Blocked: Task M (blocker description)
Next: Task N+1 (ready to start)
Token Usage: Xk/1M (Y% utilized)
```

---

**This is your recipe for autonomous feature implementation. Follow it religiously. Keep going until the work is done.**
